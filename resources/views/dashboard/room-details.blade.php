            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-[25px] mb-[25px]">
                <div class="xl:col-span-1">
                    <div class="trezo-card">
                        <div class="trezo-card-content" id="roomDetailsImageSlides">
                            <div class="swiper mySwiper2">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="bg-white dark:bg-[#0c1427] p-[13px]">
                                            <img class="rounded-md" src="/assets/images/rooms/room-details1.jpg" alt="room-details-image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bg-white dark:bg-[#0c1427] p-[13px]">
                                            <img class="rounded-md" src="/assets/images/rooms/room-details2.jpg" alt="room-details-image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bg-white dark:bg-[#0c1427] p-[13px]">
                                            <img class="rounded-md" src="/assets/images/rooms/room-details3.jpg" alt="room-details-image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="bg-white dark:bg-[#0c1427] p-[13px]">
                                            <img class="rounded-md" src="/assets/images/rooms/room-details4.jpg" alt="room-details-image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div thumbsSlider class="swiper mySwiper mt-[15px]">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="rounded-md cursor-pointer" src="/assets/images/rooms/room-details1.jpg" alt="room-details-image">
                                    </div>
                                    <div class="swiper-slide cursor-poiner">
                                        <img class="rounded-md cursor-pointer" src="/assets/images/rooms/room-details2.jpg" alt="room-details-image">
                                    </div>
                                    <div class="swiper-slide cursor-poiner">
                                        <img class="rounded-md cursor-pointer" src="/assets/images/rooms/room-details3.jpg" alt="room-details-image">
                                    </div>
                                    <div class="swiper-slide cursor-poiner">
                                        <img class="rounded-md cursor-pointer" src="/assets/images/rooms/room-details4.jpg" alt="room-details-image">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md lg:h-full">
                        <div class="trezo-card-content">
                            <div class="sm:flex items-center gap-[15px]">
                                <img src="/assets/images/users/user80.jpg" alt="user-image" class="rounded-full w-[85px]">
                                <div class="mt-[15px] sm:mt-0">
                                    <span class="block text-xs">
                                        Code: TRZ-32
                                    </span>
                                    <h3 class="!text-[20px] md:!text-xl !mb-0 mt-[5px]">
                                        Serenity Suite
                                    </h3>
                                    <ul>
                                        <li class="inline-block relative mt-[10px] ltr:mr-[17px] rtl:ml-[17px] ltr:pl-[25px] rtl:pr-[25px] ltr:last:mr-0 rtl:last:ml-0">
                                            <i class="ri-phone-fill absolute ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 text-orange-500 text-lg"></i>
                                            +321 1245 6457
                                        </li>
                                        <li class="inline-block relative mt-[10px] ltr:mr-[17px] rtl:ml-[17px] ltr:pl-[25px] rtl:pr-[25px] ltr:last:mr-0 rtl:last:ml-0">
                                            <i class="ri-mail-line absolute ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 text-orange-500 text-lg"></i>
                            ...
                            <div class="sm:flex gap-[40px]">
                                <div class="flex items-center gap-[10px] mb-[15px] last:mb-0 sm:mb-0">
                                    <img src="/assets/images/icons/schedule.svg" alt="schedule">
                                    <div>
                                        <span class="text-xs block mb-px">
                                            Check In
                                        </span>
                            ...
                            <ul class="mb-[20px] md:mb-[25px] grid grid-cols-1 sm:grid-cols-2">
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    ...
                                    <span class="block">
                                        <span class="text-black dark:text-white">L1-15</span>
                                    </span>
                                </li>
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    <span class="block">
                                    ...
                                    <span class="block">
                                        <span class="text-black dark:text-white">2</span>
                                    </span>
                                </li>
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    <span class="block">
                                    ...
                                    <span class="block">
                                        <span class="text-black dark:text-white">Moonlight</span>
                                    </span>
                                </li>
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    <span class="block">
                                ...
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    ...
                                    <span class="block">
                                        <span class="text-black dark:text-white">$156</span>/night
                                    </span>
                                </li>
                                <li class="flex items-center justify-between py-[10px] px-[20px] border border-gray-100 dark:border-[#15203c]">
                                    <span class="block">
                            ...
                            <p>
                                This room captures the essence of boundless potential, symbolized by a surreal landscape where the sky meets the earth in a dazzling fusion of colors. The intricate design features flowing lines that blend together, representing the limitless paths we can take in life.
                            </p>
                        </div>
                    </div>
                </div>
