                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-[25px] mb-[25px]">
                            ...
                            <div class="trezo-card-content">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500" placeholder="E.g. 123 Main Street, Anytown, USA">
                                    </div>
                                    <div>
                                        <label class="mb-[10px] text-black dark:text-white font-medium block">
                                            Country
                                ...
                                <button type="button" class="mt-[20px] md:mt-[25px] font-medium inline-block transition-all rounded-md md:text-md ltr:mr-[15px] rtl:ml-[15px] py-[10px] md:py-[12px] px-[20px] md:px-[22px] bg-danger-500 text-white hover:bg-danger-400">
                                    Cancel
                                </button>
                    ...
                    <div class="lg:col-span-1">
                        <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                            ...
                            <div class="trezo-card-content">
                                <div class="flex items-center justify-between mb-[20px]">
                                    ...
                                    <a href="#" class="inline-block text-primary-500">
                                        Edit Cart
                                    </a>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            ...
                            <div class="trezo-card-content">
                                <div class="mb-[20px] mb-[25px] last:mb-0">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">
                                        Payment Card
                                    </label>
                                    <select class="h-[55px] rounded-md border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[13px] block w-full outline-0 cursor-pointer transition-all focus:border-primary-500">
                                ...
                                <div class="mb-[20px] mb-[25px] last:mb-0">
                                    ...
                                    <input type="text" class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500" placeholder="E.g. 3588XXXXXXXXX">
                                </div>
                                <div class="mb-[20px] mb-[25px] last:mb-0">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">
                                        Expiration Date
                                    </label>
                                    <input type="text" class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500" placeholder="E.g. MM / YY">
                                </div>
                                <div class="mb-[20px] mb-[25px] last:mb-0">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">
                                        Security Code
                                    </label>
                                    <input type="text" class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500" placeholder="E.g. CVV">
                                </div>
                            </div>
                        </div>
                    </div>
