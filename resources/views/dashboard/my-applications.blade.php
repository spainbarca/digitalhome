                            ...
                            <ul class="mb-[20px] md:mb-[25px]">
                                <li class="font-medium mb-[15px] md:mb-[19px] last:mb-0">
                                    ...
                                    <ul class="ltr:pl-[28px] rtl:pr-[28px] mt-[15px] md:mt-[17px] mb-[17px] md:mb-[21px]">
                                        ...
                                        <li class="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                                            <a href="/dashboard/my-applications" class="inline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] text-primary-500">
                                                <span class="ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 w-[6px] h-[6px] rounded-full absolute border border-primary-500"></span>
                                                Applications
                                            </a>
                                        </li>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-[25px]">
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/figma.svg" alt="figma-image">
                                    </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/dribbble.svg" alt="dribbble-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        React Template
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/spotify.svg" alt="spotify-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        Material UI
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/gitlab.svg" alt="gitlab-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        WP Themes
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/google-drive.svg" alt="google-drive-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        Personal Photos
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/trello.svg" alt="trello-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        Mobile Apps
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/slack.svg" alt="slack-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        Important Files
                                    </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px] flex items-center">
                                    <div class="leading-none ltr:mr-[12px] rtl:ml-[12px]">
                                        <img src="/assets/images/icons/pinterest.svg" alt="pinterest-image">
                                    </div>
                                    <h6 class="!mb-0 !text-[15px]">
                                        Angular Template
                                    </h6>
