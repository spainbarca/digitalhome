        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[20px] md:mb-[25px] flex items-center justify-between -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">
                        <i class="material-symbols-outlined !text-[20px] align-middle mr-[6px] text-primary-500">work</i>
                        Registrar Empleo
                    </h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.empleos.store') }}">
                        @csrf
                            ...
                            <div>
                                ...
                                <select name="hogar_miembro_id" id="hogar_miembro_id" class="w-full">
                                    ...
                                    @foreach($miembros as $m)
                                        ...
                                        <option value="{{ $m->id }}"
                                            data-avatar="{{ $avatarM ?? '' }}"
                                            {{ old('hogar_miembro_id') == $m->id ? 'selected' : '' }}>
                                            {{ $nombreM }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px] mb-[25px]">
                                ...
                                <select name="estado_empleo_id" id="estado_empleo_id" class="w-full">
                                    ...
                                    @foreach($estados as $est)
                                        <option value="{{ $est->id }}"
                                            ...
                                            {{ old('estado_empleo_id') == $est->id ? 'selected' : '' }}>
                                            {{ $est->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="modalidad_laboral_id" id="modalidad_laboral_id" class="w-full">
                                    ...
                                    @foreach($modalidades as $mod)
                                        <option value="{{ $mod->id }}"
                                            ...
                                            {{ old('modalidad_laboral_id') == $mod->id ? 'selected' : '' }}>
                                            {{ $mod->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="1"
                                    ...
                                    placeholder="Describe las responsabilidades del cargo...">{{ old('descripcion') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px] mb-[25px]">
                            ...
                            <!-- Fecha fin -->
                            <div>
                                <label class="mb-[10px] text-black dark:text-white font-medium block">Fecha de Fin <span class="text-gray-400 text-xs font-normal">(dejar vacío si es actual)</span></label>
                            ...
                            <div>
                                <label class="mb-[10px] text-black dark:text-white font-medium block">Venc. de Contrato <span class="text-gray-400 text-xs font-normal">(opcional)</span></label>
                                <input type="date" name="fecha_vencimiento_contrato" value="{{ old('fecha_vencimiento_contrato') }}"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                    ...
                                    <div class="w-[130px]">
                                        <select name="moneda_id" id="moneda_id" class="w-full h-[55px]">
                                            ...
                                            @foreach($monedas as $mon)
                                                <option value="{{ $mon->id }}"
                                                    {{ old('moneda_id', $monedaLocal?->id) == $mon->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 gap-[20px] md:gap-[25px] mb-[25px]">
                            ...
                            <div>
                                ...
                                <textarea name="logros" rows="3"
                                    class="rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                                    placeholder="Describe los logros obtenidos en este empleo...">{{ old('logros') }}</textarea>
