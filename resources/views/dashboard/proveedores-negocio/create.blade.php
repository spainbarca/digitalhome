...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Nuevo Proveedor del Negocio</title>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.proveedores-negocio.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div id="condicionWrapper" class="relative">
                                    ...
                                    <input type="hidden" name="condicion_pago" id="condicion_pago" value="{{ old('condicion_pago', '') }}">
                        ...
                        <div class="mb-[25px] grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                            <div>
                                ...
                                <label class="mb-[10px] text-black dark:text-white font-medium block">
                                    Logo del proveedor <span class="text-xs text-gray-400 font-normal">(PNG/JPG/WebP, máx. 2 MB)</span>
                                </label>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400 mb-[8px]">Recomendado 1200×300 px.</p>
        ...
        <script>
            ...
            function onLogoFileChange(input) {
                ...
                if (input.files && input.files[0]) {
                    ...
                    if (currentEmpresaLogo) { img.src = currentEmpresaLogo; wrap.classList.remove('hidden'); }
                    else { wrap.classList.add('hidden'); }
                }
            }

            function setLogoPreviewFromEmpresa(url) {
                currentEmpresaLogo = url || '';
            ...
            (function () {
                ...
                function aplicar(id, nombre, logo, sigla, nombreComercial) {
                    hidden.value = id;
                    ...
                    if (siglaInput && !siglaInput.value && id) siglaInput.value = sigla || '';
                    const nombreInput = document.getElementById('nombre');
                    if (nombreInput && !nombreInput.value && id) nombreInput.value = nombreComercial || '';
                }
                ...
                opciones.forEach(li => {
                    li.addEventListener('click', () => {
                        aplicar(li.dataset.id, li.dataset.nombre, li.dataset.logo, li.dataset.sigla, li.dataset.nombreComercial);
                        cerrar();
                    });
                });
                ...
                if (initId) {
                    ...
                    if (m) aplicar(m.dataset.id, m.dataset.nombre, m.dataset.logo, m.dataset.sigla, m.dataset.nombreComercial);
                }
            })();
