        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header sm:flex items-center justify-between">
                    ...
                    <div class="trezo-card-subtitle mt-[15px] sm:mt-0 sm:flex items-center gap-[20px]">
                        ...
                        <div class="trezo-card-dropdown relative mt-[15px] sm:mt-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[25px] mb-[25px]">
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product6.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product7.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product8.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product9.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product10.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product11.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product12.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product13.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                ...
                <div class="md:mb-[10px] lg:mb-[17px]">
                    <div class="relative">
                        <span class="block ltr:right-0 rtl:left-0 bottom-0 w-[65px] h-[65px] absolute ltr:rounded-tl-md rtl:rounded-tr-md bg-white dark:bg-[#0c1427]"></span>
                        <a href="/dashboard/product-details" class="block rounded-md">
                            <img src="/assets/images/products/product14.jpg" alt="product-image" class="rounded-md">
                        </a>
                        <button class="rounded-md transition-all z-[1] inline-block absolute ltr:right-0 rtl:left-0 bottom-0 w-[60px] h-[60px] leading-[72px] bg-primary-500 text-white hover:bg-primary-400" type="button">
                            <i class="material-symbols-outlined">
                                shopping_cart
                    ...
                    <div class="sm:flex sm:items-center justify-between">
                        ...
                        <ol class="mt-[10px] sm:mt-0">
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/products-grid" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-gray-100 dark:border-[#172036] transition-all hover:bg-primary-500 hover:text-white hover:border-primary-500">
                            ...
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/products-grid" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-primary-500 bg-primary-500 text-white">
                                    1
                                </a>
                            </li>
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
