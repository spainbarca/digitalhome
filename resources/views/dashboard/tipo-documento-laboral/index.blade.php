...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tipos de Documento Laboral</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Tipos de Documento Laboral</h5>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-100 dark:border-[#172036]">
                                    ...
                                    <th class="text-left py-[13px] px-[16px] text-sm font-semibold text-gray-500 dark:text-gray-400 w-[110px]">Req. Venc.</th>
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    data-icono="{{ $t->icono ?? '' }}"
                                    data-requiere_vencimiento="{{ $t->requiere_vencimiento ? '1' : '0' }}"
                                    ...
                                    <td class="py-[13px] px-[16px]">
                                        @if($t->requiere_vencimiento)
                                            <span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] text-orange-600 border border-orange-400 bg-orange-100 dark:bg-[#0c1427]">Sí</span>
                                        @else
                                            <span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] text-gray-500 border border-gray-300 bg-gray-100 dark:bg-[#0c1427]">No</span>
                                        @endif
                                    </td>
                                    <td class="py-[13px] px-[16px]">
                                        @if($t->activo)
                                ...
                                <tr id="filaVacia">
                                    <td colspan="6" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        <i class="material-symbols-outlined !text-[48px] text-gray-300 dark:text-gray-600 block mb-[10px]">description</i>
                                        No hay tipos de documento laboral registrados.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modalTipo" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Tipo de Documento Laboral</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="255" placeholder="Ej: Contrato de trabajo"
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.tipo-documento-laboral.store') }}';
            const baseUrl    = '{{ url('dashboard/tipo-documento-laboral') }}';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent          = 'Nuevo Tipo de Documento Laboral';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent          = 'Editar Tipo de Documento Laboral';
                ...
                document.getElementById('modalRequiereVencimiento').checked = fila.dataset.requiere_vencimiento === '1';
            ...
            function badgeReqVenc(val) {
                return val
                    ? '<span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] text-orange-600 border border-orange-400 bg-orange-100">Sí</span>'
                    : '<span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] text-gray-500 border border-gray-300 bg-gray-100">No</span>';
            }
            ...
            function prependarFila(t) {
                ...
                tr.dataset.requiere_vencimiento = t.requiere_vencimiento ? '1' : '0';
                ...
                tr.innerHTML = `
                    ...
                    <td class="py-[13px] px-[16px]">${badgeReqVenc(t.requiere_vencimiento)}</td>
            ...
            function actualizarFila(t) {
                ...
                tds[2].textContent = t.descripcion || '—';
                tds[3].innerHTML   = badgeReqVenc(t.requiere_vencimiento);
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="6" class="text-center py-[50px] text-gray-500">
                    <i class="material-symbols-outlined !text-[48px] text-gray-300 block mb-[10px]">description</i>
                    No hay tipos de documento laboral registrados.</td>`;
