    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nueva Capacitación</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.capacitaciones.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div>
                                ...
                                <select name="empleo_id" id="empleo_id" class="w-full">
                                    ...
                                    <option value="{{ $emp->id }}"
                                        ...
                                        data-label="{{ $emp->cargo }}{{ $nombreEmp ? ' @ ' . $nombreEmp : '' }}"
                                        {{ old('empleo_id') == $emp->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px] mb-[25px]">
                                ...
                                <select name="tipo_capacitacion_id" id="tipo_capacitacion_id" class="w-full">
                                    ...
                                    @foreach($tipos as $t)
                                        <option value="{{ $t->id }}"
                                            ...
                                            {{ old('tipo_capacitacion_id') == $t->id ? 'selected' : '' }}>
                                            {{ $t->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="2"
                                    ...
                                    placeholder="Descripción del curso o programa...">{{ old('descripcion') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px] mb-[25px]">
                            <div>
                                ...
                                <select name="institucion_educativa_id" id="institucion_educativa_id" class="w-full">
                                    ...
                                    <option value="{{ $ie->id }}"
                                        ...
                                        {{ old('institucion_educativa_id') == $ie->id ? 'selected' : '' }}>
                            ...
                            <div>
                                <label class="mb-[10px] text-black dark:text-white font-medium block">
                                    O nombre libre <span class="text-gray-400 text-xs font-normal">(si no está en el listado)</span>
                                </label>
                                <input type="text" name="institucion_nombre" value="{{ old('institucion_nombre') }}"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px] mb-[25px]">
                            ...
                            <div>
                                ...
                                <input type="number" name="horas_academicas" value="{{ old('horas_academicas') }}" min="0"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500"
                                    placeholder="Ej: 40">
                            ...
                            <div>
                                ...
                                <input type="text" name="codigo_certificado" value="{{ old('codigo_certificado') }}"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div>
                                ...
                                <input type="url" name="url_verificacion" value="{{ old('url_verificacion') }}"
                                    class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500"
                            ...
                            <div class="sm:col-span-2">
                                <label class="mb-[10px] text-black dark:text-white font-medium block">
                                    ...
                                    <span class="text-xs text-gray-400 font-normal">(PDF / JPG / PNG — máx. 10 MB)</span>
                                </label>
        ...
        <script>
        // Datos de empleos para filtrar por miembro
        ...
        $(function () {
            ...
            // Init: filter empleos by preselected miembro
