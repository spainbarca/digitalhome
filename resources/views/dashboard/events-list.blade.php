                ...
                <div class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex items-center justify-between">
                    <div class="trezo-card-title">
                        <form class="relative sm:w-[265px]">
                            ...
                            <input type="text" placeholder="Search event here....." class="bg-gray-50 border border-gray-50 h-[36px] text-xs rounded-md w-full block text-black pt-[11px] pb-[12px] ltr:pl-[38px] rtl:pr-[38px] ltr:pr-[13px] ltr:md:pr-[16px] rtl:pl-[13px] rtl:md:pl-[16px] placeholder:text-gray-500 outline-0 dark:bg-[#15203c] dark:text-white dark:border-[#15203c] dark:placeholder:text-gray-400">
                        </form>
                    </div>
                    <div class="trezo-card-subtitle mt-[15px] sm:mt-0">
                        <a href="/dashboard/create-an-event" class="inline-block transition-all rounded-md font-medium px-[13px] py-[6px] text-primary-500 border border-primary-500 hover:bg-primary-500 hover:text-white">
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="text-black dark:text-white">
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event1.jpg">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event2.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event3.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event4.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event5.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                                Tech Summit 2025
                                            </span>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event6.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                                Startup Pitch Day
                                            </span>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event7.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event8.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                                Charity Gala Dinner
                                            </span>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event9.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] border-b border-gray-100 dark:border-[#172036] ltr:first:border-l ltr:last:border-r rtl:first:border-r rtl:last:border-l">
                                        <a href="/dashboard/event-details" class="flex items-center text-black dark:text-white transition-all hover:text-primary-500">
                                            <img class="rounded-md w-[40px]" alt="event-image" src="/assets/images/events/event10.jpg">
                                            <span class="block text-[15px] font-medium ltr:ml-[12px] rtl:mr-[12px]">
                                                Networking Mixer
                                            </span>
                                        </a>
                    ...
                    <div class="px-[20px] py-[12px] md:py-[14px] rounded-b-md border-l border-r border-b border-gray-100 dark:border-[#172036] sm:flex sm:items-center justify-between">
                        ...
                        <ol class="mt-[10px] sm:mt-0">
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/events-list" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-gray-100 dark:border-[#172036] transition-all hover:bg-primary-500 hover:text-white hover:border-primary-500">
                            ...
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/events-list" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-primary-500 bg-primary-500 text-white">
                                    1
                                </a>
                            </li>
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
