...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Documentos Médicos</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Documentos Médicos</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <form method="GET" action="{{ route('dashboard.documentos-medicos.index') }}" class="flex flex-wrap items-end gap-[12px]">
                    ...
                    <div class="flex gap-[8px]">
                        ...
                        @if($miembroId || $tipoId || $consultaId || $fechaDesde || $fechaHasta)
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                    ...
                    <a href="{{ route('dashboard.documentos-medicos.create') }}"
                        ...
                        <table class="w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap uppercase text-[10px] font-bold tracking-[1px] ltr:text-left pt-0 pb-[12.5px] px-[20px] text-gray-500 dark:text-gray-400">Consulta</th>
                            ...
                            <tbody class="text-black dark:text-white">
                                ...
                                <tr>
                                    ...
                                    <td class="ltr:text-left px-[20px] py-[12.5px] border-b border-primary-50 dark:border-[#172036] max-w-[220px]">
                                        ...
                                        @if($doc->tipoDocumentoMedico)
                                        <span class="block text-xs text-gray-400 mt-[2px]">{{ $doc->tipoDocumentoMedico->nombre }}</span>
                                        @endif
                                        @if($esImagen)
                                        ...
                                        <span class="inline-flex items-center gap-[3px] text-[10px] text-gray-400 mt-[2px]">
                                            <i class="material-symbols-outlined !text-[11px]">attach_file</i> {{ $doc->archivo_mime ?? 'archivo' }}
                                        </span>
                                        @endif
                                    </td>
                                    <td class="ltr:text-left whitespace-nowrap px-[20px] py-[12.5px] border-b border-primary-50 dark:border-[#172036]">
                                        <span class="text-xs font-semibold text-gray-600 dark:text-gray-400">{{ trim($docMiembro) ?: '—' }}</span>
                                    </td>
                                    <td class="ltr:text-left whitespace-nowrap px-[20px] py-[12.5px] border-b border-primary-50 dark:border-[#172036]">
                                    ...
                                    <td class="ltr:text-left px-[20px] py-[12.5px] border-b border-primary-50 dark:border-[#172036] max-w-[180px]">
                                        @if($doc->consultaMedica)
                                        <a href="{{ route('dashboard.consultas-medicas.show', $doc->consultaMedica) }}"
                                            class="text-xs text-primary-500 hover:underline truncate block">
                                            {{ $doc->consultaMedica->fecha?->format('d/m/Y') }}
                                            @if($doc->consultaMedica->motivo)
                                                — {{ Str::limit($doc->consultaMedica->motivo, 30) }}
                                            @endif
                                        </a>
                                        @else
                                        <span class="text-xs text-gray-400">Sin consulta</span>
                                        @endif
                                    </td>
                                    <td class="ltr:text-left whitespace-nowrap px-[20px] py-[12.5px] border-b border-primary-50 dark:border-[#172036] ltr:last:pr-0">
                                        <div class="flex items-center gap-[9px]">
                                            ...
                                            <a href="{{ route('dashboard.documentos-medicos.edit', $doc) }}"
                                                class="text-gray-500 dark:text-gray-400 leading-none custom-tooltip" data-text="Editar">
                                                <i class="material-symbols-outlined !text-md">edit</i>
                                            </a>
                                            <form method="POST" action="{{ route('dashboard.documentos-medicos.destroy', $doc) }}" class="inline leading-none">
                                                @csrf @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="6" class="text-center px-[20px] py-[50px] text-gray-500 dark:text-gray-400">
                                        ...
                                        No hay documentos médicos registrados.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
