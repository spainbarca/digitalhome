    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Producto Financiero</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.productos-financieros.update', $productoFinanciero) }}" id="productoForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="col-span-12 sm:col-span-9" id="entidadWrapper">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="hidden" name="entidad_financiera_id" id="entidad_financiera_id" value="{{ old('entidad_financiera_id', $productoFinanciero->entidad_financiera_id) }}">
                                ...
                                <div class="col-span-12 sm:col-span-3" id="tipoWrapper">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="hidden" name="tipo_producto_financiero_id" id="tipo_producto_financiero_id" value="{{ old('tipo_producto_financiero_id', $productoFinanciero->tipo_producto_financiero_id) }}">
                                        <div id="tipoDropdown"
                                            class="hidden absolute z-[50] w-full bg-white dark:bg-[#0c1427] border border-gray-200 dark:border-[#172036] rounded-md shadow-lg mt-[4px]">
                                            <div class="p-[8px] border-b border-gray-100 dark:border-[#172036]">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px] mb-[20px] md:mb-[25px]">
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="text" name="alias" value="{{ old('alias', $productoFinanciero->alias) }}" maxlength="255"
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <select name="moneda_id"
                                        ...
                                        <option value="{{ $m->id }}" {{ old('moneda_id', $productoFinanciero->moneda_id) == $m->id ? 'selected' : '' }}>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <select name="estado_producto_id"
                                        ...
                                        <option value="{{ $es->id }}" {{ old('estado_producto_id', $productoFinanciero->estado_producto_id) == $es->id ? 'selected' : '' }}>{{ $es->nombre }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="col-span-12 sm:col-span-6 flex items-center gap-[12px] pt-[28px]">
                                    ...
                                    <label class="relative cursor-pointer">
                                        ...
                                        <input type="checkbox" name="es_mancomunada" value="1" class="sr-only peer" {{ old('es_mancomunada', $productoFinanciero->es_mancomunada) ? 'checked' : '' }}>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div id="bloqueCuenta" class="dynamic-block hidden grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="text" name="numero_cuenta" value="{{ old('numero_cuenta', $productoFinanciero->numero_cuenta) }}" maxlength="255"
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="text" name="cci" value="{{ old('cci', $productoFinanciero->cci) }}" maxlength="255"
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="number" step="0.01" name="saldo_actual" value="{{ old('saldo_actual', $productoFinanciero->saldo_actual) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div id="bloqueTarjeta" class="dynamic-block hidden grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <input type="text" name="ultimos_digitos" value="{{ old('ultimos_digitos', $productoFinanciero->ultimos_digitos) }}" maxlength="4" inputmode="numeric"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500 font-mono">
                                </div>
                                <div class="col-span-12 sm:col-span-3">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Línea de Crédito</label>
                                    <input type="number" step="0.01" name="linea_credito" value="{{ old('linea_credito', $productoFinanciero->linea_credito) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-3">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Día de Corte</label>
                                    <input type="number" min="1" max="31" name="dia_corte" value="{{ old('dia_corte', $productoFinanciero->dia_corte) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-3">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Día de Pago</label>
                                    <input type="number" min="1" max="31" name="dia_pago" value="{{ old('dia_pago', $productoFinanciero->dia_pago) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12">
                                    ...
                                    <select name="producto_padre_id"
                                        ...
                                        <option value="{{ $pp->id }}" {{ old('producto_padre_id', $productoFinanciero->producto_padre_id) == $pp->id ? 'selected' : '' }}>
                            ...
                            <div id="bloquePrestamo" class="dynamic-block hidden grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="number" step="0.01" name="cuota" value="{{ old('cuota', $productoFinanciero->cuota) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-4">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Plazo (meses)</label>
                                    <input type="number" min="0" name="plazo_meses" value="{{ old('plazo_meses', $productoFinanciero->plazo_meses) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-4">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">TCEA (%)</label>
                                    <input type="number" step="0.001" name="tasa_tcea" value="{{ old('tasa_tcea', $productoFinanciero->tasa_tcea) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-4">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Fecha de Apertura</label>
                                    <input type="date" name="fecha_apertura" value="{{ old('fecha_apertura', $productoFinanciero->fecha_apertura?->format('Y-m-d')) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                            </div>
                            ...
                            <div id="bloquePlazoFijo" class="dynamic-block hidden grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="number" step="0.001" name="tasa_tea" value="{{ old('tasa_tea', $productoFinanciero->tasa_tea) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                <div class="col-span-12 sm:col-span-6">
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Fecha de Apertura</label>
                                ...
                                <div class="col-span-12 sm:col-span-6">
                                    ...
                                    <input type="date" name="fecha_vencimiento" value="{{ old('fecha_vencimiento', $productoFinanciero->fecha_vencimiento?->format('Y-m-d')) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                            </div>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-2xl">
                                <textarea name="notas" rows="3"
                                    ...
                                    class="rounded-md text-black dark:text-white border {{ $errors->has('notas') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('notas', $productoFinanciero->notas) }}</textarea>
