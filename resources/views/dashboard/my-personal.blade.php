                            ...
                            <ul class="mb-[20px] md:mb-[25px]">
                                <li class="font-medium mb-[15px] md:mb-[19px] last:mb-0">
                                    ...
                                    <ul class="ltr:pl-[28px] rtl:pr-[28px] mt-[15px] md:mt-[17px] mb-[17px] md:mb-[21px]">
                                        ...
                                        <li class="font-normal mb-[12px] md:mb-[14px] last:mb-0">
                                            <a href="/dashboard/my-personal" class="inline-block relative transition-all hover:text-primary-500 ltr:pl-[15px] rtl:pr-[15px] text-primary-500">
                                                <span class="ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2 w-[6px] h-[6px] rounded-full absolute border border-primary-500"></span>
                                                Personal
                                            </a>
                                        </li>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-[25px]">
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/txt.png" alt="png-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Projects
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/pdf.png" alt="pdf-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Documents
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/xl4.png" alt="xl4-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Media
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/jpg.png" alt="jpg-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Applications
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/png.png" alt="png-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        ET Template
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/txt.png" alt="txt-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Material UI
                                    </h6>
                                </div>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                            <div class="trezo-card-content">
                                ...
                                <div class="mt-[20px] md:mt-[30px] lg:mt-[40px]">
                                    <img src="/assets/images/icons/doc.png" alt="doc-image">
                                    <h6 class="!mb-0 !text-[15px] mt-[18px]">
                                        Mobile Apps
                                    </h6>
                                </div>
