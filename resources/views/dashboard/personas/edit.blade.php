...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <form method="POST" action="{{ route('dashboard.personas.update', $persona) }}">
                @csrf
                @method('PUT')
                            ...
                            <div class="trezo-card-content">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] sm:gap-[25px]">
                                    ...
                                    <div>
                                        ...
                                        <select name="tipo_documento_id"
                                            ...
                                            @foreach ($tiposDocumento as $tipo)
                                                <option value="{{ $tipo->id }}" {{ old('tipo_documento_id', $persona->tipo_documento_id) == $tipo->id ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="numero_documento" value="{{ old('numero_documento', $persona->numero_documento) }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $persona->fecha_nacimiento?->format('Y-m-d')) }}"
                                    ...
                                    <div>
                                        ...
                                        <select name="sexo"
                                            ...
                                            <option value="otro" {{ old('sexo', $persona->sexo) === 'otro' ? 'selected' : '' }}>Otro</option>
                                        </select>
                                        @error('sexo')
                                            <p class="mt-[6px] text-danger-500 text-sm flex items-center gap-[5px]">
                                                <i class="material-symbols-outlined !text-base">error</i> {{ $message }}
                                ...
                                <div class="flex flex-col gap-[20px]">
                                    ...
                                    <div>
                                        ...
                                        <select name="tipo_sangre"
                                            ...
                                            @foreach (['A+','A-','B+','B-','AB+','AB-','O+','O-'] as $grupo)
                                                <option value="{{ $grupo }}" {{ old('tipo_sangre', $persona->tipo_sangre) === $grupo ? 'selected' : '' }}>{{ $grupo }}</option>
                                            @endforeach
                                        </select>
                                        @error('tipo_sangre')
                                            <p class="mt-[6px] text-danger-500 text-sm flex items-center gap-[5px]">
                                    ...
                                    <div class="flex items-center justify-between p-[15px] rounded-md bg-gray-50 dark:bg-[#15203c]">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <input type="checkbox" name="activo" value="1" {{ old('activo', $persona->activo) ? 'checked' : '' }} class="sr-only peer">
                ...
                <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                    <div class="flex items-center gap-[12px]">
                        <a href="{{ route('dashboard.personas.show', $persona) }}" class="font-medium inline-block transition-all rounded-md py-[10px] md:py-[12px] px-[20px] md:px-[22px] bg-gray-100 dark:bg-[#15203c] text-black dark:text-white hover:bg-gray-200 dark:hover:bg-[#1e2d4a]">
                            Cancelar
                        </a>
