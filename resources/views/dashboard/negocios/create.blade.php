    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nuevo Negocio</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Registrar Negocio</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.negocios.store') }}">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <div class="h-[55px] flex items-center rounded-md border border-gray-100 dark:border-[#172036] bg-gray-50 dark:bg-[#15203c] px-[17px]">
                                        ...
                                        <span id="sectorDisplay" class="text-gray-400 dark:text-gray-500 text-sm italic">Se obtiene de la empresa</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_inicio_actividades"
                                        value="{{ old('fecha_inicio_actividades', '') }}"
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="observaciones" rows="3"
                                        ...
                                        class="rounded-md text-black dark:text-white border {{ $errors->has('observaciones') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('observaciones', '') }}</textarea>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-[20px] md:gap-[25px]">
                                ...
                                <div id="regimenWrapper" class="relative">
                                    ...
                                    <input type="hidden" name="regimen_tributario_id" id="regimen_tributario_id" value="{{ old('regimen_tributario_id', '') }}">
                                    <div id="regimenDropdown" class="hidden absolute z-[50] w-full bg-white dark:bg-[#0c1427] border border-gray-200 dark:border-[#172036] rounded-md shadow-lg mt-[4px]">
                                        <ul class="max-h-[220px] overflow-y-auto py-[4px]">
                                            <li class="regimen-opcion flex items-center gap-[8px] px-[12px] py-[9px] cursor-pointer hover:bg-primary-50 dark:hover:bg-[#15203c] transition-colors"
                                                data-id="" data-nombre="Sin especificar" data-codigo="">
                                                <i class="material-symbols-outlined !text-[18px] text-gray-400">remove_circle_outline</i>
                                ...
                                <div id="tipoSocWrapper" class="relative">
                                    ...
                                    <input type="hidden" name="tipo_sociedad_id" id="tipo_sociedad_id" value="{{ old('tipo_sociedad_id', '') }}">
                                ...
                                <div id="estadoWrapper" class="relative">
                                    ...
                                    <input type="hidden" name="estado_negocio_id" id="estado_negocio_id" value="{{ old('estado_negocio_id', '') }}">
                                    <div id="estadoDropdown" class="hidden absolute z-[50] w-full bg-white dark:bg-[#0c1427] border border-gray-200 dark:border-[#172036] rounded-md shadow-lg mt-[4px]">
                                        <ul class="max-h-[220px] overflow-y-auto py-[4px]">
                                            <li class="estado-opcion flex items-center gap-[8px] px-[12px] py-[9px] cursor-pointer hover:bg-primary-50 dark:hover:bg-[#15203c] transition-colors"
                                                data-id="" data-nombre="Sin especificar" data-color="">
                                                <span class="w-[10px] h-[10px] rounded-full bg-gray-300 flex-shrink-0 block"></span>
                                                <span class="text-sm text-gray-500">Sin especificar</span>
                                            </li>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div id="miembroWrapper" class="relative">
                                ...
                                <input type="hidden" name="miembro_id" id="miembro_id" value="{{ old('miembro_id', '') }}">
        ...
        <script>
            ...
            (function () {
                ...
                function aplicar(id, nombre, logo, sector) {
                    ...
                    if (id) {
                        ...
                        iconContainer.innerHTML = logo
                            ...
                            : '<i class="material-symbols-outlined !text-[20px] text-primary-500">business</i>';
                        sectorDisplay.textContent = sector || '—';
                        sectorDisplay.className = 'text-black dark:text-white text-sm';
                    } else {
                        ...
                        sectorDisplay.textContent = 'Se obtiene de la empresa';
                        sectorDisplay.className = 'text-gray-400 dark:text-gray-500 text-sm italic';
                    }
                }
                ...
                opciones.forEach(li => {
                    li.addEventListener('click', () => {
                        aplicar(li.dataset.id, li.dataset.nombre, li.dataset.logo, li.dataset.sector);
                        cerrar();
                    });
                });
                document.addEventListener('click', e => { if (!wrapper.contains(e.target)) cerrar(); });
                ...
                if (initId) {
                    ...
                    if (m) aplicar(m.dataset.id, m.dataset.nombre, m.dataset.logo, m.dataset.sector);
                }
            })();
            ...
            makeSimpleDropdown('regimenWrapper','regimenTrigger','regimenDropdown','regimenChevron','regimen_tributario_id','regimenLabel','regimen-opcion',
                function(li, label) {
                    ...
                    if (li.dataset.id) {
                        label.textContent = li.dataset.codigo ? `${li.dataset.codigo} — ${li.dataset.nombre}` : li.dataset.nombre;
                        label.className = 'text-black dark:text-white text-sm flex-1 truncate';
                        iconEl.innerHTML = `<i class="material-symbols-outlined !text-[20px] text-primary-500">${icono}</i>`;
                    } else {
                        label.textContent = 'Sin especificar';
                        label.className = 'text-gray-500 dark:text-gray-400 text-sm flex-1 truncate';
                        iconEl.innerHTML = `<i class="material-symbols-outlined !text-[20px] text-gray-400">${icono}</i>`;
                    }
                }
            );
            ...
            (function () {
                ...
                function abrir() { dropdown.classList.remove('hidden'); chevron.style.transform = 'rotate(180deg)'; }
                function cerrar() { dropdown.classList.add('hidden'); chevron.style.transform = ''; }
                function aplicar(id, nombre, color, icono) {
                    hidden.value = id;
                    const iconEl = document.getElementById('estadoIconEl');
                    if (id) {
                        label.textContent = nombre;
                        label.className = 'text-black dark:text-white text-sm flex-1 truncate';
                        dot.style.backgroundColor = color || '#6b7280';
                        iconEl.innerHTML = `<i class="material-symbols-outlined !text-[20px] text-primary-500">${icono || 'store'}</i>`;
                    } else {
                        label.textContent = 'Sin especificar';
                        label.className = 'text-gray-500 dark:text-gray-400 text-sm flex-1 truncate';
                        dot.style.backgroundColor = '#d1d5db';
                        iconEl.innerHTML = '<i class="material-symbols-outlined !text-[20px] text-gray-400">store</i>';
                    }
                }
                ...
                opciones.forEach(li => {
                    li.addEventListener('click', () => { aplicar(li.dataset.id, li.dataset.nombre, li.dataset.color, li.dataset.icono); cerrar(); });
                });
                document.addEventListener('click', e => { if (!wrapper.contains(e.target)) cerrar(); });
                ...
                if (initId) {
                    const m = [...opciones].find(li => li.dataset.id === initId);
                    if (m) aplicar(m.dataset.id, m.dataset.nombre, m.dataset.color, m.dataset.icono);
                }
            })();
            ...
            (function () {
                ...
                function aplicar(id, nombre, foto) {
                    hidden.value = id;
                    const ic = document.getElementById('miembroIconContainer');
                    if (id) {
                        label.textContent = nombre;
                        label.className = 'text-black dark:text-white text-sm flex-1 truncate';
                        ic.innerHTML = foto
                            ? `<img src="${foto}" style="width:32px;height:32px;border-radius:50%;object-fit:cover;">`
                            : '<div style="width:32px;height:32px;border-radius:50%;background:#e0e7ff;display:flex;align-items:center;justify-content:center;"><i class="material-symbols-outlined" style="font-size:18px;color:#6366f1;">person</i></div>';
                    } else {
                        label.textContent = 'Sin representante legal';
                        label.className = 'text-gray-500 dark:text-gray-400 text-sm flex-1 truncate';
                        ic.innerHTML = '<i class="material-symbols-outlined !text-[24px] text-gray-400">person</i>';
                    }
                }
                ...
                opciones.forEach(li => {
                    li.addEventListener('click', () => { aplicar(li.dataset.id, li.dataset.nombre, li.dataset.foto); cerrar(); });
                });
                document.addEventListener('click', e => { if (!wrapper.contains(e.target)) cerrar(); });
