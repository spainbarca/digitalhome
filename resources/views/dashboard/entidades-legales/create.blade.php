...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Nueva Entidad Legal</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nueva Entidad Legal</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Registrar Entidad Legal</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.entidades-legales.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <div class="relative" id="tipoWrapper">
                                        ...
                                        <input type="hidden" name="tipo_entidad_legal_id" id="tipo_entidad_legal_id" value="{{ old('tipo_entidad_legal_id', '') }}">
                                        <div id="tipoDropdown"
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <select name="empresa_id" id="empresa_id"
                                        class="block w-full {{ $errors->has('empresa_id') ? 'border-danger-500' : '' }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    @php $oldDistrito = old('distrito_inei') ? \App\Models\UbigeoDistrito::find(old('distrito_inei')) : null; @endphp
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mb-[8px]">Imagen cuadrada o circular.</p>
                                    <div id="logoPreviewWrap" class="hidden mb-[10px]">
                                        <img id="logoPreview" src="" alt="Preview logo" class="w-[64px] h-[64px] rounded-full object-cover border border-gray-200 dark:border-[#172036]">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mb-[8px]">Imagen de fondo de la tarjeta.</p>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mb-[8px]">Banner horizontal para el detalle.</p>
                        ...
                        <div class="mt-[20px] flex justify-end gap-[15px]">
                            <a href="{{ route('dashboard.entidades-legales.index') }}"
        ...
        <script>
            ...
            $(document).ready(function () {
                // Select2 para empresa (con clear)
                $('#empresa_id').select2({
