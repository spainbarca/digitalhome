                            ...
                            <div class="px-[20px] py-[12px] md:py-[14px] rounded-b-md border-l border-r border-b border-gray-100 dark:border-[#172036] sm:flex sm:items-center justify-between">
                                ...
                                <ol class="mt-[10px] sm:mt-0">
                                    <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                        <a href="/dashboard/customer-details" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-gray-100 dark:border-[#172036] transition-all hover:bg-primary-500 hover:text-white hover:border-primary-500">
                                    ...
                                    <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                        <a href="/dashboard/customer-details" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-primary-500 bg-primary-500 text-white">
                                            1
                                        </a>
                                    </li>
                                    <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        <div class="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
                            <div class="trezo-card-title flex items-center">
                                <img src="/assets/images/users/user11.jpg" alt="user-image" class="rounded-full w-[65px] h-[65px] border-[2px] border-gray-100 dark:border-[#172036]">
                                <div class="ltr:ml-[12px] rtl:mr-[12px]">
                                    <span class="block font-medium text-black dark:text-white mb-[2px] text-md">
                                        Ava Turner
                                    </span>
                                    <span class="block">
                                        Team Leader
                        ...
                        <div class="trezo-card-content">
                            <ul>
                                <li class="mb-[15px] md:mb-[17px] last:mb-0 text-black dark:text-white font-medium">
                                    <span class="block font-normal mb-[5px] text-gray-500 dark:text-gray-400">
                                        Account ID:
                                    </span>
                                    ID-12174123
                                </li>
