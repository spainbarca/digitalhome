...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar — {{ $prestatario->nombre_resuelto }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Prestatario</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">
                        <a href="{{ route('dashboard.prestamos.prestatarios.show', $prestatario) }}" class="transition-all hover:text-primary-500 truncate">{{ $prestatario->nombre_resuelto }}</a>
                    </li>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Editar: {{ $prestatario->nombre_resuelto }}</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.prestamos.prestatarios.update', $prestatario) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                                ...
                                <div class="flex items-center gap-[14px] p-[16px] rounded-md border border-gray-200 dark:border-[#172036] bg-gray-50 dark:bg-[#15203c]">
                                    <label class="relative cursor-pointer flex-shrink-0">
                                        <input type="checkbox" name="es_miembro_hogar" id="esMiembroToggle" value="1"
                                            class="sr-only peer" {{ old('es_miembro_hogar', $prestatario->es_miembro_hogar) ? 'checked' : '' }}>
                            ...
                            {{-- Bloque miembro --}}
                            <div id="bloqueHogarMiembro" class="{{ old('es_miembro_hogar', $prestatario->es_miembro_hogar) ? '' : 'hidden' }} max-w-lg mb-[20px]">
                                ...
                                <div class="relative" id="miembroWrapper">
                                    ...
                                    <input type="hidden" name="hogar_miembro_id" id="hogar_miembro_id"
                                        value="{{ old('hogar_miembro_id', $prestatario->hogar_miembro_id ?? '') }}">
                            ...
                            <div class="max-w-lg">
                                ...
                                <input type="text" name="nombre" id="nombreInput"
                                    value="{{ old('nombre', $prestatario->nombre) }}" maxlength="255"
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="monedaWrapper">
                                    ...
                                    <input type="hidden" name="moneda_id" id="moneda_id"
                                        value="{{ old('moneda_id', $prestatario->moneda_id ?? '') }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="telefono"
                                        value="{{ old('telefono', $prestatario->telefono) }}" maxlength="30"
                                ...
                                <div>
                                    ...
                                    <div class="mb-[10px] flex items-center gap-[10px]">
                                        <img src="{{ asset('storage/' . $prestatario->foto_path) }}" id="fotoPreview"
                                            class="w-[100px] h-[100px] rounded-full object-cover border border-gray-200 dark:border-[#172036]"
                                            alt="Foto actual">
                            ...
                            <div class="mt-[20px]">
                                ...
                                <textarea name="notas" rows="3"
                                    ...
                                    class="rounded-md text-black dark:text-white border {{ $errors->has('notas') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('notas', $prestatario->notas) }}</textarea>
