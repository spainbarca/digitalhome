...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar — {{ $operadoresViaje->empresa?->razon_social ?? 'Operador de Viaje' }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Operador de Viaje</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">
                        <a href="{{ route('dashboard.operadores-viaje.show', $operadoresViaje) }}" class="transition-all hover:text-primary-500 truncate">
                            {{ $operadoresViaje->empresa?->razon_social ?? 'Detalle' }}
                        </a>
                    </li>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Editar: {{ $operadoresViaje->empresa?->razon_social ?? '—' }}</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.operadores-viaje.update', $operadoresViaje) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="hidden" name="empresa_id" id="empresa_id" value="{{ old('empresa_id', $operadoresViaje->empresa_id ?? '') }}">
                                ...
                                <input type="text" name="sigla" id="sigla"
                                    value="{{ old('sigla', $operadoresViaje->sigla ?? '') }}"
                                    maxlength="50"
                                    placeholder="Ej. LAN"
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div id="tipoWrapper" class="relative">
                                ...
                                <input type="hidden" name="tipo_operador_viaje_id" id="tipo_operador_viaje_id" value="{{ old('tipo_operador_viaje_id', $operadoresViaje->tipo_operador_viaje_id ?? '') }}">
                                <div id="tipoDropdown"
                                    class="hidden absolute z-[50] w-full bg-white dark:bg-[#0c1427] border border-gray-200 dark:border-[#172036] rounded-md shadow-lg mt-[4px]">
                                    <div class="p-[8px] border-b border-gray-100 dark:border-[#172036]">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                <div>
                                    ...
                                    <input type="text" name="codigo_iata" value="{{ old('codigo_iata', $operadoresViaje->codigo_iata) }}" maxlength="10"
                        ...
                        <div class="mb-[25px] grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                            ...
                            <div>
                                ...
                                <div id="logoPreviewWrap" class="{{ $operadoresViaje->logo_resuelto ? '' : 'hidden' }} mb-[10px]">
                                    <img id="logoPreview" src="{{ $operadoresViaje->logo_resuelto ?? '' }}" alt="Logo"
                            ...
                            <div>
                                ...
                                <div id="bannerPreviewWrap" class="{{ $operadoresViaje->banner_url ? '' : 'hidden' }} mb-[10px]">
                                    <img id="bannerPreview" src="{{ $operadoresViaje->banner_url ?? '' }}" alt="Banner"
                        ...
                        <div class="mt-[20px] flex justify-end gap-[15px]">
                            <a href="{{ route('dashboard.operadores-viaje.show', $operadoresViaje) }}"
        ...
        <script>
            ...
            let currentEmpresaLogo = @json($operadoresViaje->empresa?->logo_url ? asset('storage/' . $operadoresViaje->empresa->logo_url) : null);
            ...
            function setLogoPreviewFromEmpresa(empresaLogoUrl) {
                ...
                return; // operador tiene logo propio — empresa no lo sobreescribe
                @endif
                const wrap = document.getElementById('logoPreviewWrap');
                const img  = document.getElementById('logoPreview');
                if (currentEmpresaLogo) {
