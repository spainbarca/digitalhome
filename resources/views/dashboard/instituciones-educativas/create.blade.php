...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Nueva Institución Educativa</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nueva Institución Educativa</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Registrar Institución Educativa</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.instituciones-educativas.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="tipoInstWrapper">
                                    ...
                                    <input type="hidden" name="tipo_institucion_educativa_id" id="tipo_institucion_educativa_id" value="{{ old('tipo_institucion_educativa_id', '') }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <input type="text" name="nombre_referencial" value="{{ old('nombre_referencial') }}" maxlength="255"
