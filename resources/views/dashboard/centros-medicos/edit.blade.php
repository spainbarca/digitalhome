    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Centro Médico</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">
                        <a href="{{ route('dashboard.centros-medicos.show', $centro) }}" class="transition-all hover:text-primary-500 truncate">{{ $nombreEfectivo }}</a>
                    </li>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.centros-medicos.update', $centro) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="hidden" name="empresa_id" id="empresa_id" value="{{ old('empresa_id', $centro->empresa_id ?? '') }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="tipoCentroWrapper">
                                    ...
                                    <input type="hidden" name="tipo_centro_medico_id" id="tipo_centro_medico_id"
                                        value="{{ old('tipo_centro_medico_id', $centro->tipo_centro_medico_id) }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <input type="text" name="nombre_referencial" value="{{ old('nombre_referencial', $centro->nombre_referencial) }}" maxlength="150"
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <textarea name="notas" rows="3" maxlength="2000"
                                        ...
                                        class="rounded-md text-black dark:text-white border {{ $errors->has('notas') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('notas', $centro->notas) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <div class="mb-[10px] flex items-center gap-[10px]">
                                        <img src="{{ Storage::url($centro->imagen_path) }}" id="imagenPreview"
                                            class="w-[80px] h-[80px] rounded-md object-cover" alt="Imagen actual">
                                ...
                                <div class="flex items-center gap-[12px] pt-[10px] sm:pt-[30px]">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="checkbox" name="activo" value="1" class="sr-only peer" {{ old('activo', $centro->activo) ? 'checked' : '' }}>
                        ...
                        <div class="mt-[20px] flex justify-end gap-[15px]">
                            <a href="{{ route('dashboard.centros-medicos.show', $centro) }}"
