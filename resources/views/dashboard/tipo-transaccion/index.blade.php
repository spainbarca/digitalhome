    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Tipos de Transacción</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Tipos de Transacción</li>
                </ol>
            </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-100 dark:border-[#172036]">
                                    ...
                                    <th class="text-left py-[13px] px-[16px] text-sm font-semibold text-gray-500 dark:text-gray-400 w-[110px]">Naturaleza</th>
                                    <th class="text-left py-[13px] px-[16px] text-sm font-semibold text-gray-500 dark:text-gray-400 w-[100px]">Color</th>
                            ...
                            <tbody id="tablaBody">
                                @forelse($tipos as $t)
                                @php
                                    $natLabel = ['ingreso' => 'Ingreso', 'egreso' => 'Egreso', 'neutro' => 'Neutro'];
                                    $natClass = [
                                        'ingreso' => 'text-green-700 border-green-500 bg-green-100',
                                        'egreso'  => 'text-red-700 border-red-500 bg-red-100',
                                        'neutro'  => 'text-gray-700 border-gray-400 bg-gray-100',
                                    ];
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    <td class="py-[13px] px-[16px]">
                                        <i class="material-symbols-outlined !text-[22px] text-primary-500">{{ $t->icono ?? 'swap_horiz' }}</i>
                                    </td>
                                    <td class="py-[13px] px-[16px] text-sm text-black dark:text-white font-medium">{{ $t->nombre }}</td>
                                    <td class="py-[13px] px-[16px]">
                                        @if($t->naturaleza)
                                            <span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] border {{ $natClass[$t->naturaleza] ?? 'text-gray-700 border-gray-400 bg-gray-100' }}">
                                                {{ $natLabel[$t->naturaleza] ?? $t->naturaleza }}
                                            </span>
                                        @else
                                    ...
                                    <td class="py-[13px] px-[16px]">
                                        <span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] border text-white"
                                              style="background-color: {{ $color }}; border-color: {{ $color }}">
                                            {{ $color }}
                                        </span>
                                    </td>
                                    <td class="py-[13px] px-[16px] text-sm text-gray-600 dark:text-gray-400">{{ $t->descripcion ?? '—' }}</td>
                                    <td class="py-[13px] px-[16px]">
                                        @if($t->activo)
                                ...
                                <tr id="filaVacia">
                                    <td colspan="7" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        <i class="material-symbols-outlined !text-[48px] text-gray-300 dark:text-gray-600 block mb-[10px]">swap_horiz</i>
        ...
        <div id="modalTipo" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Tipo de Transacción</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="255" placeholder="Ej: Depósito"
                    ...
                    <div>
                        <label class="mb-[8px] text-black dark:text-white font-medium block text-sm">Naturaleza <span class="text-danger-500">*</span></label>
                        <select id="modalNaturaleza"
                            class="h-[46px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[14px] block w-full outline-0 transition-all focus:border-primary-500 text-sm">
                            <option value="ingreso">Ingreso</option>
                            <option value="egreso">Egreso</option>
                            <option value="neutro">Neutro</option>
                        </select>
                        <p id="errNaturaleza" class="hidden text-xs text-danger-500 mt-[5px]"></p>
                    </div>

                    <div>
                        <label class="mb-[8px] text-black dark:text-white font-medium block text-sm">Color <span class="text-danger-500">*</span></label>
                        <div class="flex items-center gap-[10px]">
                            <input type="color" id="modalColor" value="#22c55e"
                                class="w-[46px] h-[46px] rounded-md border border-gray-200 dark:border-[#172036] cursor-pointer p-[2px] bg-white dark:bg-[#0c1427]">
                            <span id="previewColorHex" class="text-sm text-gray-600 dark:text-gray-400 font-mono">#22c55e</span>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[10px]">
                            <input type="text" id="modalIcono" maxlength="100" placeholder="Ej: swap_horiz"
                            ...
                            <div class="flex-shrink-0 w-[46px] h-[46px] rounded-md border border-gray-200 dark:border-[#172036] flex items-center justify-center bg-primary-50 dark:bg-[#15203c]">
                                <i class="material-symbols-outlined !text-[22px] text-primary-500" id="previewIcono">swap_horiz</i>
                            </div>
                        </div>
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.tipo-transaccion.store') }}';
            const baseUrl    = '{{ url('dashboard/tipo-transaccion') }}';
            const iconDefault = 'swap_horiz';
            let   modoEdicion = false;
            let   idEditando  = null;

            const natLabels  = { ingreso: 'Ingreso', egreso: 'Egreso', neutro: 'Neutro' };
            const natClasses = {
                ingreso: 'text-green-700 border-green-500 bg-green-100',
                egreso:  'text-red-700 border-red-500 bg-red-100',
                neutro:  'text-gray-700 border-gray-400 bg-gray-100',
            ...
            document.getElementById('modalColor').addEventListener('input', function () {
                document.getElementById('previewColorHex').textContent = this.value;
            });

            function badgeNaturaleza(nat) {
                if (!nat) return '<span class="text-gray-400">—</span>';
                const cls   = natClasses[nat] ?? 'text-gray-700 border-gray-400 bg-gray-100';
                const label = natLabels[nat] ?? nat;
                return `<span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] border ${cls}">${esc(label)}</span>`;
            }

            function badgeColor(color) {
                const c = color || '#6b7280';
                return `<span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] border text-white" style="background-color:${esc(c)};border-color:${esc(c)}">${esc(c)}</span>`;
            }
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent  = 'Nuevo Tipo de Transacción';
                document.getElementById('modalId').value            = '';
                document.getElementById('modalNombre').value        = '';
                document.getElementById('modalDescripcion').value   = '';
                document.getElementById('modalNaturaleza').value    = 'ingreso';
                document.getElementById('modalColor').value         = '#22c55e';
                document.getElementById('previewColorHex').textContent = '#22c55e';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent  = 'Editar Tipo de Transacción';
                ...
                document.getElementById('modalNaturaleza').value    = fila.dataset.naturaleza || 'neutro';
                document.getElementById('modalColor').value         = fila.dataset.color || '#6b7280';
                document.getElementById('previewColorHex').textContent = fila.dataset.color || '#6b7280';
            ...
            async function guardar() {
                ...
                const payload = {
                    ...
                    naturaleza:  document.getElementById('modalNaturaleza').value,
            ...
            function prependarFila(t) {
                ...
                tr.dataset.naturaleza  = t.naturaleza ?? '';
                tr.dataset.icono       = t.icono ?? '';
                tr.dataset.color       = t.color ?? '#6b7280';
                ...
                tr.innerHTML = `
                    ...
                    <td class="py-[13px] px-[16px]">${badgeNaturaleza(t.naturaleza)}</td>
                    <td class="py-[13px] px-[16px]">${badgeColor(t.color)}</td>
                    <td class="py-[13px] px-[16px] text-sm text-gray-600">${esc(t.descripcion) || '—'}</td>
            ...
            function actualizarFila(t) {
                ...
                tds[2].innerHTML   = badgeNaturaleza(t.naturaleza);
                tds[3].innerHTML   = badgeColor(t.color);
                tds[4].textContent = t.descripcion || '—';
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="7" class="text-center py-[50px] text-gray-500">
                    <i class="material-symbols-outlined !text-[48px] text-gray-300 block mb-[10px]">swap_horiz</i>
                    No hay tipos de transacción registrados.</td>`;
                document.getElementById('tablaBody').appendChild(tr);
            }

            function mostrarErrores(errors) {
                const mapa = { nombre: 'errNombre', descripcion: 'errDescripcion', naturaleza: 'errNaturaleza', color: 'errColor', icono: 'errIcono' };
            ...
            function limpiarErrores() {
                ['errNombre', 'errDescripcion', 'errNaturaleza', 'errColor', 'errIcono'].forEach(id => {
                    const el = document.getElementById(id);
                    el.textContent = '';
