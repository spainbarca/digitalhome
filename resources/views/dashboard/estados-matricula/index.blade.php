...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Estados de Matrícula</title>
    ...
    <body>
        ...
        $colorClasses = [
            ...
            'purple' => 'text-purple-700 border-purple-600 bg-purple-100',
            'grey'   => 'text-gray-700 border-gray-600 bg-gray-100',
        ];
        $colorLabels = [
            'green'  => 'Verde',
            'red'    => 'Rojo',
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Estados de Matrícula</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Estados de Matrícula</li>
                </ol>
            </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    data-icono="{{ $e->icono ?? '' }}"
                                    data-color="{{ $e->color ?? 'grey' }}"
                                    data-activo="{{ $e->activo ? '1' : '0' }}">
                                    <td class="py-[13px] px-[16px]">
                                        <i class="material-symbols-outlined !text-[22px] text-primary-500">{{ $e->icono ?? 'badge' }}</i>
                                    </td>
                                    ...
                                    <td class="py-[13px] px-[16px]">
                                        @php $cls = $colorClasses[$e->color ?? 'grey'] ?? $colorClasses['grey']; @endphp
                                        <span class="inline-block text-xs font-medium px-[8px] py-[2px] rounded-[100px] border {{ $cls }}">
                                            {{ $colorLabels[$e->color ?? 'grey'] ?? $e->color }}
                                        </span>
                                    </td>
                                    <td class="py-[13px] px-[16px]">
                                        @if($e->activo)
                                ...
                                <tr id="filaVacia">
                                    <td colspan="6" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        ...
                                        No hay estados de matrícula registrados.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modalEstado" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Estado de Matrícula</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="100" placeholder="Ej: Activo"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[10px]">
                            <input type="text" id="modalIcono" maxlength="100" placeholder="Ej: badge"
                            ...
                            <div class="flex-shrink-0 w-[46px] h-[46px] rounded-md border border-gray-200 dark:border-[#172036] flex items-center justify-center bg-primary-50 dark:bg-[#15203c]">
                                <i class="material-symbols-outlined !text-[22px] text-primary-500" id="previewIcono">badge</i>
                            </div>
                        </div>
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.estados-matricula.store') }}';
            const baseUrl    = '{{ url('dashboard/estados-matricula') }}';
            const iconDefault = 'badge';
            ...
            const colorLabels = {
                ...
                orange: 'Naranja', purple: 'Morado', grey: 'Gris',
            };
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent  = 'Nuevo Estado de Matrícula';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent  = 'Editar Estado de Matrícula';
                ...
                document.getElementById('modalColor').value         = fila.dataset.color || 'grey';
            ...
            function actualizarPreviewColor() {
                ...
                preview.className = `flex-shrink-0 inline-block text-xs font-medium px-[12px] py-[6px] rounded-[100px] border ${colorClasses[color] ?? colorClasses['grey']}`;
            ...
            function badgeColor(color) {
                const cls   = colorClasses[color] ?? colorClasses['grey'];
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="6" class="text-center py-[50px] text-gray-500">
                    <i class="material-symbols-outlined !text-[48px] text-gray-300 block mb-[10px]">badge</i>
                    No hay estados de matrícula registrados.</td>`;
