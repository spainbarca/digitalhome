...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Categorías de Concepto</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Categorías de Concepto</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Préstamos</li>
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Categorías de Concepto</li>
                </ol>
            </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    <td class="py-[13px] px-[16px] text-sm text-gray-600 dark:text-gray-400">{{ $c->descripcion ?? '—' }}</td>
                                    <td class="py-[13px] px-[16px]">
                                        @if($c->activo)
                                ...
                                <tr id="filaVacia">
                                    <td colspan="5" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        ...
                                        No hay categorías de concepto registradas.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modalCategoria" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nueva Categoría de Concepto</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="255" placeholder="Ej: Dinero / Efectivo"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[10px]">
                            <input type="text" id="modalIcono" maxlength="100" placeholder="Ej: payments"
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.prestamos.categorias-concepto.store') }}';
            const baseUrl    = '{{ url('dashboard/finanzas/prestamos/categorias-concepto') }}';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent  = 'Nueva Categoría de Concepto';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent  = 'Editar Categoría de Concepto';
            ...
            function prependarFila(c) {
                ...
                tr.innerHTML = `
                    ...
                    <td class="py-[13px] px-[16px] text-sm text-gray-600">${esc(c.descripcion) || '—'}</td>
            ...
            function actualizarFila(c) {
                ...
                tds[2].textContent = c.descripcion || '—';
                tds[3].innerHTML   = badgeActivo(c.activo);
                tds[4].innerHTML   = `<div class="flex justify-end">${botonesHtml(c)}</div>`;
            }
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="5" class="text-center py-[50px] text-gray-500">
                    ...
                    No hay categorías de concepto registradas.</td>`;
