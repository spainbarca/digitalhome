...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Nuevo Proveedor de Servicio</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nuevo Proveedor de Servicio</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.proveedores.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-[25px]">
                            ...
                            <!-- Tipo de servicio — custom select con íconos material-symbols -->
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="tipoServicioWrapper">
                                    ...
                                    <input type="hidden" name="tipo_servicio_id" id="tipo_servicio_id" value="{{ old('tipo_servicio_id', '') }}">
                        ...
                        <div class="mb-[25px]">
                            <div class="flex items-center gap-[8px] mb-[15px] pb-[12px] border-b border-gray-100 dark:border-[#172036]">
                                ...
                                <span class="text-xs text-gray-400">Opcional — para proveedores formales con RUC</span>
                            </div>
                            <div class="max-w-lg">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nombre_comercial" value="{{ old('nombre_comercial') }}" maxlength="150"
                                ...
                                <div>
                                    ...
                                    <input type="url" name="sitio_web" value="{{ old('sitio_web') }}" maxlength="200"
