                ...
                <div class="trezo-card-content">
                    <form>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[15px] sm:gap-[20px]">
                            <div>
                                <input type="text" class="h-[44px] rounded-md text-black dark:text-white bg-gray-50 dark:bg-[#0a0e19] px-[17px] block w-full outline-0 placeholder:text-gray-500 dark:placeholder:text-gray-400" placeholder="Search">
                            </div>
                            <div>
                                <select class="h-[44px] rounded-md bg-gray-50 dark:bg-[#0a0e19] px-[13px] block w-full outline-0 cursor-pointer">
                                    <option selected>
                                        Category
                                    </option>
                                    <option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-[15px] md:gap-[20px] mt-[15px] md:mt-[20px] items-center">
                            <div class="md:col-span-2">
                                <div class="relative md:-top-[5px] md:pt-[2px] ltr:pl-[50px] rtl:pr-[50px] ltr:md:pl-[71px] rtl:md:pr-[71px]" id="priceRangeSlider">
                                    <span class="block font-semibold absolute ltr:left-0 rtl:right-0 top-1/2 -translate-y-1/2">
                                        Price:
                                    </span>
                                    <div id="rangeSlider" class="range-slider">
                                        ...
                                        <div class="range-group relative -mt-[10px] ltr:ml-[32px] rtl:mr-[32px] ltr:mr-[53px] rtl:ml-[53px]">
                            ...
                            <div class="md:col-span-1 ltr:md:text-right rtl:md:text-left">
                                <button type="submit" class="inline-block md:text-md font-medium bg-primary-500 text-white rounded-[7px] py-[6px] px-[25px] md:px-[53px] hover:bg-primary-400 mt-[8px] md:mt-0">
                                    Filter
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="sm:flex sm:items-center justify-between">
                        ...
                        <ol class="mt-[10px] sm:mt-0">
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/nft-explore-all" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-gray-100 dark:border-[#172036] transition-all hover:bg-primary-500 hover:text-white hover:border-primary-500">
                            ...
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
                                <a href="/dashboard/nft-explore-all" class="w-[31px] h-[31px] block leading-[29px] relative text-center rounded-md border border-primary-500 bg-primary-500 text-white">
                                    1
                                </a>
                            </li>
                            <li class="inline-block mx-[1px] ltr:first:ml-0 ltr:last:mr-0 rtl:first:mr-0 rtl:last:ml-0">
