...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar — {{ $empleador->nombre }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Empleador</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">
                        <a href="{{ route('dashboard.empleadores.show', $empleador) }}" class="transition-all hover:text-primary-500 truncate">{{ $empleador->nombre }}</a>
                    </li>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Editar: {{ $empleador->nombre }}</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.empleadores.update', $empleador) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="hidden" name="empresa_id" id="empresa_id" value="{{ old('empresa_id', $empleador->empresa_id ?? '') }}">
                                ...
                                <input type="text" name="sigla" id="sigla"
                                    value="{{ old('sigla', $empleador->sigla ?? '') }}"
                                    maxlength="50"
                                    placeholder="Ej. BCP"
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 gap-[20px] md:gap-[25px]">
                                <div>
                                    ...
                                    <input type="text" name="nombre" value="{{ old('nombre', $empleador->nombre) }}" maxlength="255"
                                ...
                                <div>
                                    ...
                                    <textarea name="descripcion" rows="3"
                                        ...
                                        class="rounded-md text-black dark:text-white border {{ $errors->has('descripcion') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[12px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('descripcion', $empleador->descripcion) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="direccion" rows="2"
                                        ...
                                        class="rounded-md text-black dark:text-white border {{ $errors->has('direccion') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[12px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('direccion', $empleador->direccion) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="relative" id="distritoWrapper">
                                        ...
                                        <input type="hidden" name="distrito_inei" id="distrito_inei" value="{{ old('distrito_inei', $empleador->distrito_inei ?? '') }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-[20px] md:gap-[25px]">
                                <div>
                                    ...
                                    <input type="text" name="telefono" value="{{ old('telefono', $empleador->telefono) }}" maxlength="30"
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $empleador->email) }}" maxlength="150"
                                ...
                                <div>
                                    ...
                                    <input type="url" name="sitio_web" value="{{ old('sitio_web', $empleador->sitio_web) }}" maxlength="255"
                        ...
                        <div class="mb-[25px]">
                            <div class="flex items-center gap-[8px] mb-[15px] pb-[12px] border-b border-gray-100 dark:border-[#172036]">
                                ...
                                <span class="text-xs text-gray-400">PNG/JPG/WebP, máx. 2 MB — dejar vacío para conservar la actual</span>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-[20px] md:gap-[25px]">

                                <div>
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Logo</label>
                                    @if($empleador->logo_path)
                                    <div class="mb-[10px]">
                                        <img src="{{ Storage::url($empleador->logo_path) }}" alt="Logo actual" class="w-[80px] h-[80px] rounded-md object-cover">
                                        <p class="text-xs text-gray-400 mt-[4px]">Logo actual</p>
                                    </div>
                                    @endif
                                    <div id="logoPreviewWrap" class="hidden mb-[10px]">
                                        ...
                                        <p class="text-xs text-primary-500 mt-[4px]">Nuevo logo</p>
                                    </div>
                                ...
                                <div>
                                    ...
                                    @if($empleador->imagen_path)
                                    <div class="mb-[10px]">
                                        <img src="{{ Storage::url($empleador->imagen_path) }}" alt="Imagen actual" class="w-[80px] h-[80px] rounded-md object-cover">
                                        <p class="text-xs text-gray-400 mt-[4px]">Imagen actual</p>
                                    </div>
                                    @endif
                                    <div id="imagenPreviewWrap" class="hidden mb-[10px]">
                                        ...
                                        <p class="text-xs text-primary-500 mt-[4px]">Nueva imagen</p>
                                    </div>
                                ...
                                <div>
                                    ...
                                    @if($empleador->banner_path)
                                    <div class="mb-[10px]">
                                        <img src="{{ Storage::url($empleador->banner_path) }}" alt="Banner actual" class="w-full h-[80px] rounded-md object-cover">
                                        <p class="text-xs text-gray-400 mt-[4px]">Banner actual</p>
                                    </div>
                                    @endif
                                    <div id="bannerPreviewWrap" class="hidden mb-[10px]">
                                        ...
                                        <p class="text-xs text-primary-500 mt-[4px]">Nuevo banner</p>
                                    </div>
                            ...
                            <div class="flex items-center gap-[12px]">
                                ...
                                <label class="relative cursor-pointer">
                                    <input type="checkbox" name="activo" value="1" class="sr-only peer"
                                        {{ old('activo', $empleador->activo ? '1' : '') ? 'checked' : '' }}>
                        ...
                        <div class="mt-[20px] flex justify-end gap-[15px]">
                            <a href="{{ route('dashboard.empleadores.show', $empleador) }}"
