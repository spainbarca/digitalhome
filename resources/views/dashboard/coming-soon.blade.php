                ...
                <div class="table-cell align-middle">
                    <div class="mx-auto px-[12.5px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1255px]">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-[25px] items-center">
                            <div class="xl:ltr:-mr-[25px] xl:rtl:-ml-[25px] rounded-md order-2 lg:order-1">
                                <img src="/assets/images/coming-soon.jpg" alt="coming-soon-image" class="rounded-md">
                            </div>
                            <div class="xl:ltr:pl-[90px] xl:rtl:pr-[90px] 2xl:ltr:pl-[120px] 2xl:rtl:pr-[120px] order-1 lg:order-2">
                                ...
                                <div class="my-[17px] md:my-[25px]">
                                    <h1 class="!font-semibold !text-[22px] md:!text-xl lg:!text-2xl 2xl:!text-4xl !mb-[5px] md:!mb-[12px]">
                                ...
                                <div class="countdown mb-[10px]" id="comingSoonCountDown">
                                    <div class="inline-block ltr:mr-[20px] ltr:md:mr-[25px] rtl:ml-[20px] rtl:md:ml-[25px] mb-[15px]">
                                        <span id="days" class="block text-black dark:text-white font-bold text-xl lg:text-2xl">00</span>
                                        Days
                                    </div>
                                    <div class="inline-block ltr:mr-[20px] ltr:md:mr-[25px] rtl:ml-[20px] rtl:md:ml-[25px] mb-[15px]">
                                        <span id="hours" class="block text-black dark:text-white font-bold text-xl lg:text-2xl">00</span>
                                        Hours
                                    </div>
                                    <div class="inline-block ltr:mr-[20px] ltr:md:mr-[25px] rtl:ml-[20px] rtl:md:ml-[25px] mb-[15px]">
                                        <span id="minutes" class="block text-black dark:text-white font-bold text-xl lg:text-2xl">00</span>
                                        Minutes
                                    </div>
                                    <div class="inline-block ltr:mr-[20px] ltr:md:mr-[25px] rtl:ml-[20px] rtl:md:ml-[25px] mb-[15px]">
                                        <span id="seconds" class="block text-black dark:text-white font-bold text-xl lg:text-2xl">00</span>
                                        Seconds
                                    </div>
                                </div>
