...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tipos de Documento Financiero</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Tipos de Documento Financiero</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Tipos de Documento Financiero</li>
                </ol>
            </div>
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr id="filaVacia">
                                    <td colspan="5" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        ...
                                        No hay tipos de documento financiero registrados.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modalTipo" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Tipo de Documento Financiero</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="255" placeholder="Ej: Estado de Cuenta"
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.tipo-documento-financiero.store') }}';
            const baseUrl    = '{{ url('dashboard/tipo-documento-financiero') }}';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent  = 'Nuevo Tipo de Documento Financiero';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent  = 'Editar Tipo de Documento Financiero';
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="5" class="text-center py-[50px] text-gray-500">
                    ...
                    No hay tipos de documento financiero registrados.</td>`;
