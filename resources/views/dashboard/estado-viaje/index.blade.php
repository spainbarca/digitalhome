    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Estados de Viaje</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Estados de Viaje</li>
                </ol>
            </div>
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    <td class="py-[13px] px-[16px]">
                                        <i class="material-symbols-outlined !text-[22px]" style="color: {{ $e->color ?? '#6b7280' }}">{{ $e->icono ?? 'flag' }}</i>
                                    </td>
        ...
        <div id="modalEstado" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Estado de Viaje</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="255" placeholder="Ej: Planificado"
        ...
        <script>
            ...
            const storeUrl   = '{{ route('dashboard.estado-viaje.store') }}';
            const baseUrl    = '{{ url('dashboard/estado-viaje') }}';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent  = 'Nuevo Estado de Viaje';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent  = 'Editar Estado de Viaje';
            ...
            function prependarFila(e) {
                ...
                tr.innerHTML = `
                    <td class="py-[13px] px-[16px]"><i class="material-symbols-outlined !text-[22px]" style="color:${esc(e.color||'#6b7280')}">${esc(e.icono || iconDefault)}</i></td>
            ...
            function actualizarFila(e) {
                ...
                tds[0].innerHTML   = `<i class="material-symbols-outlined !text-[22px]" style="color:${esc(e.color||'#6b7280')}">${esc(e.icono || iconDefault)}</i>`;
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="6" class="text-center py-[50px] text-gray-500">
                    ...
                    No hay estados de viaje registrados.</td>`;
