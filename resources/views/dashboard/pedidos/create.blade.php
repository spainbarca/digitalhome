    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <form method="POST" action="{{ route('dashboard.pedidos.store') }}">
                    @csrf
                    <div class="space-y-[16px]">
                        ...
                        <div>
                            ...
                            <select name="negocio_id" id="pedidoNegocio" required
                                ...
                                <option value="{{ $neg->id }}" {{ old('negocio_id') == $neg->id ? 'selected' : '' }}>
                    ...
                    <div class="flex items-center justify-end gap-[10px] mt-[24px] pt-[16px] border-t border-gray-100 dark:border-[#172036]">
                        <a href="{{ route('dashboard.pedidos.index') }}"
