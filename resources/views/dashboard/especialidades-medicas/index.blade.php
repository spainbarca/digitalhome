    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Especialidades Médicas</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Especialidades Médicas</li>
                </ol>
            </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-[#172036] hover:bg-gray-50 dark:hover:bg-[#15203c] transition-colors"
                                    ...
                                    data-icono="{{ $e->icono ?? '' }}"
                                    data-imagen-path="{{ $e->imagen_path ?? '' }}"
                                    data-activo="{{ $e->activo ? '1' : '0' }}">
                                    <td class="py-[13px] px-[16px]">
                                        <i class="material-symbols-outlined !text-[22px] text-primary-500">{{ $e->icono ?? 'stethoscope' }}</i>
                                    </td>
                                ...
                                <tr id="filaVacia">
                                    <td colspan="5" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        <i class="material-symbols-outlined !text-[48px] text-gray-300 dark:text-gray-600 block mb-[10px]">stethoscope</i>
        ...
        <!-- Modal -->
        <div id="modalEspecialidad" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nueva Especialidad Médica</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <input type="text" id="modalNombre" maxlength="100" placeholder="Ej: Cardiología"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[10px]">
                            <input type="text" id="modalIcono" maxlength="100" placeholder="Ej: stethoscope"
                            ...
                            <div class="flex-shrink-0 w-[46px] h-[46px] rounded-md border border-gray-200 dark:border-[#172036] flex items-center justify-center bg-primary-50 dark:bg-[#15203c]">
                                <i class="material-symbols-outlined !text-[22px] text-primary-500" id="previewIcono">stethoscope</i>
                            </div>
                        </div>
                    ...
                    <!-- Imagen path -->
                    <div>
                        <label class="mb-[8px] text-black dark:text-white font-medium block text-sm">Imagen (ruta/URL)</label>
                        <input type="text" id="modalImagenPath" maxlength="500" placeholder="Ej: /storage/especialidades/cardiologia.png"
                            class="h-[46px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[14px] block w-full outline-0 transition-all focus:border-primary-500 text-sm">
                        <p id="errImagenPath" class="hidden text-xs text-danger-500 mt-[5px]"></p>
                    </div>
        ...
        <script>
            ...
            const storeUrl    = '{{ route('dashboard.especialidades-medicas.store') }}';
            const baseUrl     = '{{ url('dashboard/especialidades-medicas') }}';
            const iconDefault  = 'stethoscope';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent    = 'Nueva Especialidad Médica';
                ...
                document.getElementById('modalImagenPath').value      = '';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent    = 'Editar Especialidad Médica';
                ...
                document.getElementById('modalImagenPath').value      = fila.dataset.imagenPath;
            ...
            async function guardar() {
                ...
                const payload = {
                    ...
                    imagen_path:  document.getElementById('modalImagenPath').value.trim() || null,
            ...
            function prependarFila(e) {
                ...
                tr.dataset.imagenPath  = e.imagen_path ?? '';
            ...
            function actualizarFila(e) {
                ...
                tds[3].innerHTML   = badgeActivo(e.activo);
                tds[4].innerHTML   = `<div class="flex justify-end">${botonesHtml(e)}</div>`;
            }
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="5" class="text-center py-[50px] text-gray-500">
                    <i class="material-symbols-outlined !text-[48px] text-gray-300 block mb-[10px]">stethoscope</i>
                    No hay especialidades médicas registradas.</td>`;
                document.getElementById('tablaBody').appendChild(tr);
            }

            function mostrarErrores(errors) {
                const mapa = { nombre: 'errNombre', descripcion: 'errDescripcion', icono: 'errIcono', imagen_path: 'errImagenPath' };
            ...
            function limpiarErrores() {
                ['errNombre', 'errDescripcion', 'errIcono', 'errImagenPath'].forEach(id => {
                    const el = document.getElementById(id);
                    el.textContent = '';
