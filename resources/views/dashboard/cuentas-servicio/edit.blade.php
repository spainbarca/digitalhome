...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar Cuenta de Servicio — {{ $propiedad->alias }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.propiedades.cuentas.update', [$propiedad, $cuenta]) }}">
                        @csrf
                        @method('PUT')
        ...
        <script>
            ...
            (function () {
                ...
                // Pre-seleccionar valor actual de la cuenta
            ...
            // Pre-filtrar proveedores según el tipo de la cuenta
            filtrarProveedores();
        </script>
    </body>
</html>
