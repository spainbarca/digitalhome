...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Estados de Negocio</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Estados de Negocio</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">Estados de Negocio</li>
                </ol>
            </div>
                            ...
                            <tbody id="tablaBody">
                                ...
                                <tr id="filaVacia">
                                    <td colspan="6" class="text-center py-[50px] text-gray-500 dark:text-gray-400">
                                        ...
                                        No hay estados de negocio registrados.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
        ...
        <div id="modalEstado" class="hidden fixed inset-0 z-[60] flex items-center justify-center" role="dialog" aria-modal="true">
            ...
            <div class="relative bg-white dark:bg-[#0c1427] rounded-md w-full max-w-md mx-[16px] shadow-2xl z-10 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-[25px] py-[18px] border-b border-gray-100 dark:border-[#172036] sticky top-0 bg-white dark:bg-[#0c1427] z-10">
                    <h5 class="!mb-0 text-[16px]" id="modalTitulo">Nuevo Estado de Negocio</h5>
                ...
                <div class="px-[25px] py-[20px] space-y-[16px]">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[10px]">
                            <input type="text" id="modalIcono" maxlength="100" placeholder="Ej: store"
        ...
        <script>
            ...
            const storeUrl    = '{{ route('dashboard.estado-negocio.store') }}';
            const baseUrl     = '{{ url('dashboard/estado-negocio') }}';
            ...
            function abrirModalCrear() {
                ...
                document.getElementById('modalTitulo').textContent      = 'Nuevo Estado de Negocio';
            ...
            function abrirModalEditar(fila) {
                ...
                document.getElementById('modalTitulo').textContent      = 'Editar Estado de Negocio';
            ...
            async function guardar() {
                ...
                const payload = {
                    ...
                    color:  document.getElementById('modalColor').value || null,
            ...
            function prependarFila(r) {
                ...
                tr.dataset.color  = r.color ?? '#6b7280';
                tr.dataset.icono  = r.icono ?? '';
                tr.dataset.orden  = r.orden ?? 0;
                tr.dataset.activo = r.activo ? '1' : '0';
                tr.innerHTML = `
                    <td class="py-[13px] px-[16px]"><i class="material-symbols-outlined !text-[22px]" style="color:${esc(r.color||'#6b7280')}">${esc(r.icono || iconDefault)}</i></td>
                    <td class="py-[13px] px-[16px] text-sm text-black font-medium">${esc(r.nombre)}</td>
                    <td class="py-[13px] px-[16px]">${badgeColor(r.color)}</td>
            ...
            function actualizarFila(r) {
                ...
                tds[0].innerHTML   = `<i class="material-symbols-outlined !text-[22px]" style="color:${esc(r.color||'#6b7280')}">${esc(r.icono || iconDefault)}</i>`;
                tds[1].textContent = r.nombre;
                tds[2].innerHTML   = badgeColor(r.color);
            ...
            function mostrarFilaVacia() {
                ...
                tr.innerHTML = `<td colspan="6" class="text-center py-[50px] text-gray-500">
                    ...
                    No hay estados de negocio registrados.</td>`;
                document.getElementById('tablaBody').appendChild(tr);
            }

            function mostrarErrores(errors) {
                const mapa = { nombre: 'errNombre', color: 'errColor', icono: 'errIcono', orden: 'errOrden' };
            ...
            function limpiarErrores() {
                ['errNombre', 'errColor', 'errIcono', 'errOrden'].forEach(id => {
                    const el = document.getElementById(id);
                    el.textContent = '';
