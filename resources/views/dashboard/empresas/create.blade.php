        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.empresas.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-[25px]">
                            <div class="flex items-center gap-[8px] mb-[15px] pb-[12px] border-b border-gray-100 dark:border-[#172036]">
                                ...
                                <h6 class="!mb-0 font-semibold text-black dark:text-white">1. Búsqueda en SUNAT</h6>
                                <span class="text-xs text-gray-400">Opcional — completa los datos automáticamente</span>
                            </div>
                            <div class="flex gap-[10px] items-start">
                                <div class="flex-1">
                                    <input type="text" id="rucInput" name="ruc" value="{{ old('ruc') }}"
                                        maxlength="11" pattern="\d{11}"
                                        placeholder="Ingresa el RUC (11 dígitos)"
                                        class="h-[55px] rounded-md text-black dark:text-white border {{ $errors->has('ruc') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500">
                                ...
                                <button type="button" id="btnBuscarRuc"
                                    ...
                                    <span id="lblBuscar">Buscar en SUNAT</span>
                                </button>
                            </div>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                    ...
                                    <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                        ...
                                        <div class="col-span-12 sm:col-span-9">
                                            ...
                                            <div class="relative" id="sectorWrapper">
                                                ...
                                                <input type="hidden" name="sector_id" id="sector_id" value="{{ old('sector_id', '') }}">
                                        ...
                                        <div class="col-span-12 sm:col-span-3">
                                            ...
                                            <input type="text" name="sigla" value="{{ old('sigla') }}" maxlength="50"
                                                placeholder="Ej. BCP"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="razon_social" name="razon_social" value="{{ old('razon_social') }}" maxlength="200"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nombre_comercial" name="nombre_comercial" value="{{ old('nombre_comercial') }}" maxlength="200"
                                ...
                                <div>
                                    ...
                                    <select name="tipo_contribuyente_id"
                                        ...
                                        @foreach($tiposContribuyente as $tipo)
                                            <option value="{{ $tipo->id }}" {{ old('tipo_contribuyente_id') == $tipo->id ? 'selected' : '' }}>
                                                {{ $tipo->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="estado_sunat" name="estado_sunat" value="{{ old('estado_sunat') }}" maxlength="50"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="condicion_sunat" name="condicion_sunat" value="{{ old('condicion_sunat') }}" maxlength="50"
                                        placeholder="Ej: HABIDO"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500">
                                </div>

                                <div>
                                    <label class="mb-[10px] text-black dark:text-white font-medium block">Fecha de Inicio de Actividades</label>
                                    <input type="date" id="fecha_inicio_actividades" name="fecha_inicio_actividades" value="{{ old('fecha_inicio_actividades') }}"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="direccion_fiscal" name="direccion_fiscal" rows="2"
                                        ...
                                        class="rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] py-[12px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('direccion_fiscal') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="distrito_inei" name="distrito_inei" value="{{ old('distrito_inei') }}" maxlength="6"
        ...
        <script>
            ...
            document.getElementById('btnBuscarRuc').addEventListener('click', async function () {
                ...
                try {
                    ...
                    mostrarEstado('success', '✓ Datos sincronizados desde PeruAPI correctamente.', ubicacion);
                    ...
                    document.getElementById('lblBuscar').textContent = 'Buscar en SUNAT';
                }
            });
