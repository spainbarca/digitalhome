                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        <div class="trezo-card-content">
                            ...
                            <ul class="mb-[20px] md:mb-[25px]">
                                ...
                                <li class="font-medium mb-[15px] md:mb-[19px] last:mb-0">
                                    <a href="/dashboard/my-documents" class="relative flex items-center justify-between ltr:pl-[28px] rtl:pr-[28px] transition-all text-primary-500 hover:text-primary-500">
                ...
                <div class="lg:col-span-3">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-[25px]">
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/txt.png" class="inline-block" alt="txt-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    Projects
                                </h6>
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/pdf.png" class="inline-block" alt="pdf-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    Documents
                                </h6>
                                <div class="flex justify-center items-center gap-[12px]">
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/xl4.png" class="inline-block" alt="xl4-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    Media
                                </h6>
                                <div class="flex justify-center items-center gap-[12px]">
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/jpg.png" class="inline-block" alt="jpg-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    Applications
                                </h6>
                                <div class="flex justify-center items-center gap-[12px]">
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/png.png" class="inline-block" alt="png-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    ET Template
                                </h6>
                                <div class="flex justify-center items-center gap-[12px]">
                        ...
                        <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md text-center">
                            <div class="trezo-card-content">
                                <img src="/assets/images/icons/doc.png" class="inline-block" alt="doc-image">
                                <h6 class="!my-[18px] !text-[15px]">
                                    Mobile Apps
                                </h6>
                                <div class="flex justify-center items-center gap-[12px]">
