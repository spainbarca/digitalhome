...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar — {{ $conceptoPago->nombre }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Editar Concepto de Pago</h5>
                <ol class="breadcrumb mt-[12px] md:mt-0">
                    ...
                    <li class="breadcrumb-item inline-block relative text-sm mx-[11px] ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0">
                        <a href="{{ route('dashboard.prestamos.conceptos-pago.show', $conceptoPago) }}" class="transition-all hover:text-primary-500 truncate">{{ $conceptoPago->nombre }}</a>
                    </li>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Editar: {{ $conceptoPago->nombre }}</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.prestamos.conceptos-pago.update', $conceptoPago) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="catWrapper">
                                    ...
                                    <input type="hidden" name="categoria_concepto_id" id="categoria_concepto_id"
                                        value="{{ old('categoria_concepto_id', $conceptoPago->categoria_concepto_id ?? '') }}">
                                    <div id="catDropdown"
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <input type="text" name="nombre" value="{{ old('nombre', $conceptoPago->nombre) }}" maxlength="255"
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <input type="number" name="precio_referencial"
                                        value="{{ old('precio_referencial', $conceptoPago->precio_referencial) }}"
                                ...
                                <div class="max-w-lg">
                                    ...
                                    <textarea name="descripcion" rows="3"
                                        ...
                                        class="rounded-md text-black dark:text-white border {{ $errors->has('descripcion') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('descripcion', $conceptoPago->descripcion) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <div class="mb-[10px] flex items-center gap-[10px]">
                                        <img src="{{ $conceptoPago->imagen_url }}" id="imagenPreview"
                                ...
                                <div class="flex items-center gap-[12px] pt-[10px] sm:pt-[30px]">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="checkbox" name="activo" value="1" class="sr-only peer"
                                            {{ old('activo', $conceptoPago->activo) ? 'checked' : '' }}>
                        ...
                        <div class="mt-[20px] flex justify-end gap-[15px]">
                            <a href="{{ route('dashboard.prestamos.conceptos-pago.show', $conceptoPago) }}"
