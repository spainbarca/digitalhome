    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nuevo Comercio</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Registrar Comercio</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.comercios.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                <label class="mb-[10px] text-black dark:text-white font-medium block">Empresa <span class="text-danger-500">*</span></label>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="relative" id="tipoComWrapper">
                                    ...
                                    <input type="hidden" name="tipo_comercio_id" id="tipo_comercio_id" value="{{ old('tipo_comercio_id', '') }}">
                            ...
                            <div class="grid grid-cols-1 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="max-w-lg flex items-center gap-[12px]">
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="checkbox" name="es_online" id="esOnlineCheck" value="1" class="sr-only peer" {{ old('es_online') ? 'checked' : '' }} onchange="toggleUbicacion()">
                                ...
                                {{-- Bloque de ubicación (se oculta si es_online) --}}
                                <div id="bloqueUbicacion" class="{{ old('es_online') ? 'hidden' : '' }}">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px] md:gap-[25px]">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 mb-[8px]">Imagen cuadrada o circular. Si no se sube, se usa el logo de la empresa.</p>
