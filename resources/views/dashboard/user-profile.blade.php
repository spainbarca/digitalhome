        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <ul class="mb-[25px] text-center">
                <li class="inline-block mx-[3px]">
                    <a href="/dashboard/user-profile" class="block py-[8.5px] px-[15px] font-medium rounded-md text-white bg-primary-500 border border-primary-500">
                        Profile
                    </a>
                </li>
                <li class="inline-block mx-[3px]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-[25px] mb-[25px]">
                <div class="lg:col-span-2">
                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        <div class="trezo-card-header mb-[20px] md:mb-[25px] pb-[20px] md:pb-[25px] flex items-center justify-between border-b border-gray-100 dark:border-[#172036]">
                        ...
                        <div class="trezo-card-content">
                            <h6 class="!text-md !mb-[11px] [&:not(:first-child)]:mt-[20px] md:[&:not(:first-child)]:mt-[25px]">
                                Introduction
                            </h6>
                            <p>
