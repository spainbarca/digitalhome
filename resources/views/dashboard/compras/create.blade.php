        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                ...
                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.compras.store') }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                                ...
                                <select name="comercio_id" id="comercio_id" class="w-full">
                                    ...
                                    @foreach($comercios as $com)
                                        ...
                                        <option value="{{ $com->id }}"
                                            ...
                                            {{ old('comercio_id') == $com->id ? 'selected' : '' }}>
                                            {{ $nombreCom }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="categoria_compra_id" id="categoria_compra_id" class="w-full">
                                    ...
                                    @foreach($categorias as $cat)
                                        <option value="{{ $cat->id }}"
                                            ...
                                            {{ old('categoria_compra_id') == $cat->id ? 'selected' : '' }}>
                                            {{ $cat->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="moneda_id" id="moneda_id" class="w-full">
                                    ...
                                    @foreach($monedas as $mon)
                                        <option value="{{ $mon->id }}" {{ old('moneda_id', $monedaLocal?->id) == $mon->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="number" name="total" value="{{ old('total') }}" step="0.01" min="0" placeholder="0.00"
                            ...
                            <div>
                                ...
                                <input type="text" name="concepto" value="{{ old('concepto') }}" placeholder="Ej: Compra supermercado"
