...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            @php
                $tipoIcono    = $documento->tipoDocumentoEducativo?->icono ?? 'description';
                ...
                <div class="lg:col-span-3 flex flex-col gap-[25px]">
                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        ...
                        <div class="mt-[16px] pt-[16px] border-t border-gray-100 dark:border-[#172036] flex gap-[10px] flex-wrap">
                            <a href="{{ route('dashboard.documentos-educativos.edit', $documento) }}"
                    ...
                    <div class="trezo-card bg-white dark:bg-[#0c1427] p-[20px] md:p-[25px] rounded-md">
                        ...
                        <div class="grid grid-cols-2 gap-[12px]">
                            <div>
                                ...
                                <span class="block text-sm font-medium text-black dark:text-white">{{ $documento->matricula->institucionEducativa?->nombre_referencial ?? '—' }}</span>
                            </div>
                            <div>
                                <span class="block text-xs text-gray-400 mb-[2px]">Año lectivo</span>
                                <span class="block text-sm font-medium text-black dark:text-white">{{ $documento->matricula->año_lectivo ?? '—' }}</span>
                            </div>
                        </div>
                        <div class="pt-[10px] mt-[10px] border-t border-gray-100 dark:border-[#172036]">
                            <a href="{{ route('dashboard.matriculas.show', $documento->matricula) }}"
