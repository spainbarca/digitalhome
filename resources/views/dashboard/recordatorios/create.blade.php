    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0">Nuevo Recordatorio</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[20px] md:mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <i class="material-symbols-outlined !text-[20px] text-primary-500 mr-[8px]">notifications</i>
                    <h5 class="!mb-0">Nuevo Recordatorio</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.recordatorios.store') }}">
                        @csrf
                        ...
                        <div class="mb-[20px]">
                            ...
                            <input type="text" name="titulo" value="{{ old('titulo') }}" maxlength="150"
                                placeholder="Ej: Renovar SOAT del auto, Pagar luz, Vence DNI..."
                        ...
                        <div class="mb-[25px]">
                            ...
                            <textarea name="descripcion" rows="3" maxlength="500" placeholder="Detalles adicionales (opcional)..."
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] mb-[25px]">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="fecha_aviso" value="{{ old('fecha_aviso') }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] mb-[25px]">
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <label class="inline-flex items-center cursor-pointer gap-[10px]">
                                    <div class="relative">
                                        ...
                                        <input type="checkbox" name="repetir" id="repetir" value="1"
                                               class="sr-only peer" {{ old('repetir') ? 'checked' : '' }}
                                ...
                                <p id="textoRepetir" class="hidden text-xs text-primary-500 mt-[6px] flex items-center gap-[4px]">
        ...
        document.getElementById('fecha_vencimiento').addEventListener('change', function () {
            ...
            var texto, cls;
            if (diff < 0) {
                texto = 'Venció hace ' + Math.abs(diff) + ' días';
                cls   = 'bg-danger-100 text-danger-700 border border-danger-300';
            } else if (diff === 0) {
                texto = '¡Vence hoy!';
                cls   = 'bg-danger-100 text-danger-700 border border-danger-300';
            } else if (diff <= 7) {
                ...
                texto = 'Faltan ' + diff + ' días';
                cls   = 'bg-warning-100 text-warning-700 border border-warning-300';
            } else {
                texto = 'Faltan ' + diff + ' días';
                cls   = 'bg-success-100 text-success-700 border border-success-300';
            }
            badge.innerHTML = '<span class="inline-block text-xs font-medium py-[2px] px-[8px] rounded-xl ' + cls + '">' + texto + '</span>';
        });

        if (document.getElementById('repetir').checked) toggleRepetir(true);
