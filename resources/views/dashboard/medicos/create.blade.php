...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <form method="POST" action="{{ route('dashboard.medicos.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="trezo-card-content">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-[20px] md:gap-[25px]">
                            ...
                            <div>
                                ...
                                <input type="text" name="cmp" value="{{ old('cmp') }}" maxlength="20"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="notas" rows="3" maxlength="2000"
                                    placeholder="Observaciones, referencias, horarios de atención..."
                                    class="rounded-md text-black dark:text-white border {{ $errors->has('notas') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-primary-500 resize-none">{{ old('notas') }}</textarea>
