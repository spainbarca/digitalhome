...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Editar Viaje — {{ $viaje->nombre }}</title>
    ...
    <body>
        ...
        <div class="main-content transition-all flex flex-col overflow-hidden min-h-screen" id="main-content">
            ...
            <div class="mb-[25px] md:flex items-center justify-between">
                <h5 class="!mb-0 truncate max-w-[60%]">Editar: {{ $viaje->nombre }}</h5>
            ...
            <div class="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
                <div class="trezo-card-header bg-gray-50 dark:bg-[#15203c] mb-[25px] flex items-center -mx-[20px] md:-mx-[25px] -mt-[20px] md:-mt-[25px] p-[20px] md:p-[25px] rounded-t-md">
                    <h5 class="!mb-0">Editar Viaje</h5>
                </div>

                <div class="trezo-card-content">
                    <form method="POST" action="{{ route('dashboard.viajes.update', $viaje) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="grid grid-cols-12 gap-[20px] md:gap-[25px]">
                                ...
                                <div class="col-span-12 sm:col-span-8">
                                    ...
                                    <input type="text" name="nombre" value="{{ old('nombre', $viaje->nombre) }}" maxlength="255"
                                        class="h-[55px] rounded-md text-black dark:text-white border {{ $errors->has('nombre') ? 'border-danger-500' : 'border-gray-200 dark:border-[#172036]' }} bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                ...
                                <div class="col-span-12 sm:col-span-4">
                                    ...
                                    <select name="tipo_viaje_id" id="tipo_viaje_id" class="w-full">
                                        ...
                                        <option value="{{ $t->id }}"
                                            ...
                                            {{ old('tipo_viaje_id', $viaje->tipo_viaje_id) == $t->id ? 'selected' : '' }}>{{ $t->nombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <input type="date" name="fecha_inicio" value="{{ old('fecha_inicio', $viaje->fecha_inicio?->format('Y-m-d')) }}"
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <input type="date" name="fecha_fin" value="{{ old('fecha_fin', $viaje->fecha_fin?->format('Y-m-d')) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <select name="moneda_id"
                                        ...
                                        <option value="{{ $m->id }}" {{ old('moneda_id', $viaje->moneda_id) == $m->id ? 'selected' : '' }}>
                                ...
                                <div class="col-span-12 sm:col-span-4">
                                    ...
                                    <input type="number" step="0.01" min="0" name="presupuesto"
                                        value="{{ old('presupuesto', $viaje->presupuesto) }}"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                                ...
                                <div class="col-span-12 sm:col-span-8">
                                    ...
                                    <input type="text" name="descripcion"
                                        value="{{ old('descripcion', $viaje->descripcion) }}" maxlength="500"
                                        class="h-[55px] rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0 transition-all focus:border-primary-500">
                                </div>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-lg">
                                ...
                                <div class="mb-[10px]">
                                    <p class="text-xs text-gray-400 mb-[6px]">Portada actual:</p>
                                    <img src="{{ $viaje->portada_url }}" class="h-[120px] w-auto rounded-md object-cover border border-gray-200 dark:border-[#172036]" alt="Portada">
                                </div>
                                @endif
                                <label class="mb-[10px] text-black dark:text-white font-medium block">
                                    {{ $viaje->portada_url ? 'Cambiar portada' : 'Imagen de portada' }}
                                    <span class="text-xs text-gray-400 font-normal ml-[4px]">(opcional — deja vacío para mantener la actual)</span>
                                </label>
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="max-w-2xl">
                                <textarea name="notas" rows="3"
                                    ...
                                    class="rounded-md text-black dark:text-white border border-gray-200 dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] py-[14px] block w-full outline-0 transition-all placeholder:text-gray-500 focus:border-primary-500 resize-none">{{ old('notas', $viaje->notas) }}</textarea>
                            </div>
                        </div>
