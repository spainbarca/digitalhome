                ...
                <div class="trezo-card-content">
                    ...
                    @if($propiedad->cuentasServicio->isEmpty())
                        <div class="text-center py-[40px]">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-sm mb-[16px]">No hay cuentas de servicio registradas.</p>
                            <a href="{{ route('dashboard.propiedades.cuentas.create', $propiedad) }}"
                            ...
                            @foreach($propiedad->cuentasServicio as $index => $cuenta)
                                ...
                                <div class="{{ $color['bg'] }} rounded-md py-[22px] px-[20px] relative">
                                    ...
                                    <div class="mt-[15px] sm:mt-[20px] flex items-center justify-between gap-[8px]">
                                        <span class="block text-sm truncate text-gray-700 dark:text-gray-300 max-w-[55%]">
